...
local function SelfViewFunction()
    ...
    Buttons.Break(L("self.berserk"))
    Buttons.Float(L("self.berserkeffect.label"), Self.Berserk.effectEnhance, tip("self.berserkeffect.tip"))
    Buttons.Toggle(L("self.berserkvisual.label"), Self.Berserk.visualEnhance, tip("self.berserkvisual.tip"))
end
