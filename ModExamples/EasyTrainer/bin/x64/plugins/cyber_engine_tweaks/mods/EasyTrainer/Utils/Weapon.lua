...
function Weapon.BeginFrame(deltaTime)
    Weapon.frameStamp = Weapon.frameStamp + 1
    ...
    Weapon.lastUpdateFrame = Weapon.frameStamp
end

function Weapon.Tick(deltaTime)
    if Weapon.lastUpdateFrame ~= Weapon.frameStamp then
        Weapon.BeginFrame(deltaTime)
    end
end
