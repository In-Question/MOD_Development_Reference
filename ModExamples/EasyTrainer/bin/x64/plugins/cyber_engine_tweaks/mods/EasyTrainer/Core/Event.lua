...
---Register a callback for CET onTweak
---@param fn fun() Function to run when tweaks are reloaded
function Event.RegisterTweak(fn)
    registerForEvent("onTweak", fn)
    Logger.Log("Event: Registered onTweak")
end
