...
local function WeaponsViewFunction()
    ...
    Buttons.Toggle(L("weaponsmenu.fastcharge.label"), Weapons.StatModifiers.FastCharge.toggleFastCharge, tip("weaponsmenu.fastcharge.tip"))
    ...
    Buttons.Toggle(L("weaponsmenu.melee_attackspeed.label"), Weapons.StatModifiers.MeleeAttackSpeed.toggleMeleeAttackSpeed, tip("weaponsmenu.melee_attackspeed.tip"))
