...
local function RegisterAllWeaponOptions()
    ...
    ConfigManager.Register("toggle.weapon.fastcharge", Weapons.StatModifiers.FastCharge.toggleFastCharge, false)
    ...
    ConfigManager.Register("toggle.weapon.melee_attackspeed", Weapons.StatModifiers.MeleeAttackSpeed.toggleMeleeAttackSpeed, false)
