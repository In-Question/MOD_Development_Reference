...
function gamedataThreatDistanceCoverSelectionParameters_Record.new() return end

---@param props table
---@return gamedataThreatDistanceCoverSelectionParameters_Record
function gamedataThreatDistanceCoverSelectionParameters_Record.new(props) return end
