...
function gamedataVehicleDriveModelData_Record.new() return end

---@param props table
---@return gamedataVehicleDriveModelData_Record
function gamedataVehicleDriveModelData_Record.new(props) return end
...
function gamedataVehicleDriveModelData_Record:BikeCurvesPath() return end

---@return Float
function gamedataVehicleDriveModelData_Record:BikeMaxTilt() return end

---@return Float
function gamedataVehicleDriveModelData_Record:BikeTiltCustomSpeed() return end

---@return Float[]
function gamedataVehicleDriveModelData_Record:BikeTiltPID() return end

---@param item Float
---@return Bool
function gamedataVehicleDriveModelData_Record:BikeTiltPIDContains(item) return end

---@return Float
function gamedataVehicleDriveModelData_Record:BikeTiltReturnSpeed() return end

---@return Float
function gamedataVehicleDriveModelData_Record:BikeTiltSpeed() return end
...
---@return Int32
function gamedataVehicleDriveModelData_Record:GetBikeTiltPIDCount() return end

---@param index Int32
---@return Float
function gamedataVehicleDriveModelData_Record:GetBikeTiltPIDItem(index) return end
...
---@return Int32
function gamedataVehicleDriveModelData_Record:GetTankSpringsLocalPositionsCount() return end

---@param index Int32
---@return Vector2
function gamedataVehicleDriveModelData_Record:GetTankSpringsLocalPositionsItem(index) return end
...
---@return Float
function gamedataVehicleDriveModelData_Record:TankAcceleration() return end

---@return Float
function gamedataVehicleDriveModelData_Record:TankCTOD() return end

---@return Float
function gamedataVehicleDriveModelData_Record:TankCTOI() return end

---@return Float
function gamedataVehicleDriveModelData_Record:TankCTOP() return end

---@return Float
function gamedataVehicleDriveModelData_Record:TankDeceleration() return end

---@return Float
function gamedataVehicleDriveModelData_Record:TankGravityMul() return end

---@return Float
function gamedataVehicleDriveModelData_Record:TankMaxSpeed() return end

---@return Float
function gamedataVehicleDriveModelData_Record:TankSpringDamping() return end

---@return Float
function gamedataVehicleDriveModelData_Record:TankSpringDistance() return end

---@return Float
function gamedataVehicleDriveModelData_Record:TankSpringRadius() return end

---@return Float
function gamedataVehicleDriveModelData_Record:TankSpringStiffness() return end

---@return Float
function gamedataVehicleDriveModelData_Record:TankSpringVerticalOffset() return end

---@return Vector2[]
function gamedataVehicleDriveModelData_Record:TankSpringsLocalPositions() return end

---@param item Vector2
---@return Bool
function gamedataVehicleDriveModelData_Record:TankSpringsLocalPositionsContains(item) return end

---@return Float
function gamedataVehicleDriveModelData_Record:TankTurningSpeed() return end
