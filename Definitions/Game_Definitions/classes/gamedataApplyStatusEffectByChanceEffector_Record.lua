...
function gamedataApplyStatusEffectByChanceEffector_Record.new() return end

---@param props table
---@return gamedataApplyStatusEffectByChanceEffector_Record
function gamedataApplyStatusEffectByChanceEffector_Record.new(props) return end
