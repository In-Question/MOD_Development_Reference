...
function worldNavigationScriptInterface.new() return end

---@param props table
---@return worldNavigationScriptInterface
function worldNavigationScriptInterface.new(props) return end
