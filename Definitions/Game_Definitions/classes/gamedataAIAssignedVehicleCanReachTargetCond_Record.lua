...
function gamedataAIAssignedVehicleCanReachTargetCond_Record.new() return end

---@param props table
---@return gamedataAIAssignedVehicleCanReachTargetCond_Record
function gamedataAIAssignedVehicleCanReachTargetCond_Record.new(props) return end
