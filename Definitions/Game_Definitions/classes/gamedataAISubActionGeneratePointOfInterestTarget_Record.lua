...
function gamedataAISubActionGeneratePointOfInterestTarget_Record.new() return end

---@param props table
---@return gamedataAISubActionGeneratePointOfInterestTarget_Record
function gamedataAISubActionGeneratePointOfInterestTarget_Record.new(props) return end
