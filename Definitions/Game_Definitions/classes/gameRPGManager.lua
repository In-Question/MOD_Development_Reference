...
function gameRPGManager.new() return end

---@param props table
---@return gameRPGManager
function gameRPGManager.new(props) return end
...
---@return Bool, CyberwareUpgradeCostData
...
---@return Bool, gamedataQuality, gamedataItem_Record, CyberwareUpgradeCostData
...
---@param itemID ItemID
---@return Bool, gamedataItem_Record
...
---@param player PlayerPuppet
---@return Bool
function gameRPGManager.ForceEquipStrongArms(player) return end
