...
function InventoryDataManagerV2.new() return end

---@param props table
---@return InventoryDataManagerV2
function InventoryDataManagerV2.new(props) return end

---@return gamedataEquipmentArea[]
function InventoryDataManagerV2.GetAllCyberwareAreas() return end

---@param itemData gameInventoryItemData
---@param attachmentID ItemID
---@return TweakDBID
...
---@param player PlayerPuppet
---@return gameItemData, gameInventoryItemData
