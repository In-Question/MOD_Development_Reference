...
function gamedataPropagateStatusEffectInAreaEffector_Record.new() return end

---@param props table
---@return gamedataPropagateStatusEffectInAreaEffector_Record
function gamedataPropagateStatusEffectInAreaEffector_Record.new(props) return end
