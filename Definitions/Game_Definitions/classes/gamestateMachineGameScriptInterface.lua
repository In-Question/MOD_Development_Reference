...
function gamestateMachineGameScriptInterface.new() return end

---@param props table
---@return gamestateMachineGameScriptInterface
function gamestateMachineGameScriptInterface.new(props) return end
...
---@return Bool, physicsTraceResult
