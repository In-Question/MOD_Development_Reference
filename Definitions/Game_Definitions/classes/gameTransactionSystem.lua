...
function gameTransactionSystem.new() return end

---@param props table
---@return gameTransactionSystem
function gameTransactionSystem.new(props) return end
...
---@param obj gameObject
---@param rootPartID ItemID
---@param replacementPartID ItemID
...
---@param force Bool
---@return Bool
function gameTransactionSystem:TransferItem(source, target, itemID, amount, dynamicTags, force) return end
