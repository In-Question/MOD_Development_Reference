...
function DefaultTransition.new() return end

---@param props table
---@return DefaultTransition
function DefaultTransition.new(props) return end
...
---@param scriptInterface gamestateMachineGameScriptInterface
---@return Bool
function DefaultTransition:ShouldEnterSafe(stateContext, scriptInterface) return end
