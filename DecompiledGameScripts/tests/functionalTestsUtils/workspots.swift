...
public class WorkspotFunctionalTestsDebugListener extends IScriptable {
  ...
  private let m_animationsStack: [String];

  private let m_animationsSkippedStack: [String];

  private let m_animationsMissingStack: [String];
  ...
  public final func GetAnimationStack() -> [String] {
  ...
  public final func GetAnimationPlayCount(const animationName: script_ref<String>) -> Int32 {
    let count: Int32 = 0;
    let i: Int32 = 0;
  ...
  public final func GetSkippedAnimationStack() -> [String] {
  ...
  public final func GetMissingAnimationStack() -> [String] {
