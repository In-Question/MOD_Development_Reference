...
public class CentaurShieldController extends AICustomComponents {
  ...
  private final func GetFloatFromCharacterTweak(const varName: script_ref<String>, opt defaultValue: Float) -> Float {
    return (this.GetOwner() as ScriptedPuppet).GetFloatFromCharacterTweak(varName, defaultValue);
  }

  private final func GetStringFromCharacterTweak(const varName: script_ref<String>, opt defaultValue: String) -> String {
