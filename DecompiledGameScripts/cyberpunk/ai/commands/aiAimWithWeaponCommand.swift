...
public class AimAtTargetCommandTask extends AIbehaviortaskScript {
  ...
  protected func Update(context: ScriptExecutionContext) -> AIbehaviorUpdateOutcome {
    ...
    this.m_threatPersistenceSource = TweakDBInterface.GetAIThreatPersistenceSourceRecord(t"AIThreatPersistenceSource.CommandAimWithWeapon");
...
public class AimAtTargetCommandCleanup extends AIbehaviortaskScript {
  ...
  private final func Deactivate(context: ScriptExecutionContext) -> Void {
    let threatPersistenceSource: ref<AIThreatPersistenceSource_Record> = TweakDBInterface.GetAIThreatPersistenceSourceRecord(t"AIThreatPersistenceSource.CommandAimWithWeapon");
