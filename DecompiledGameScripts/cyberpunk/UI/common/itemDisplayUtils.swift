...
public class ItemDisplayUtils extends IScriptable {
  ...
  public final static func SpawnCommonSlotAsync(gameController: ref<inkIGameController>, parent: inkWidgetRef, slotName: CName, opt callBack: CName, opt userData: ref<IScriptable>) -> Void {
    if IsDefined(inkWidgetRef.Get(parent)) {
