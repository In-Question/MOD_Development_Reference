...
public class CityFluffScreenSelector extends LCDScreenSelector {
  ...
  @runtimeProperty("customEditor", "TweakDBGroupInheritance;LCDScreen")
...
public class NumberPlateSelector extends LCDScreenSelector {
  ...
  @runtimeProperty("customEditor", "TweakDBGroupInheritance;NumberPlate")
  private let m_recordID: TweakDBID;
...
public class GenericStreetSignSelector extends StreetSignSelector {
  ...
  @runtimeProperty("customEditor", "TweakDBGroupInheritance;StreetSign")
  private let m_recordID: TweakDBID;
...
public class StreetNameSelector extends StreetSignSelector {
  ...
  @runtimeProperty("customEditor", "TweakDBGroupInheritance;GenericStreetNameSign")
  private let m_recordID: TweakDBID;
...
public class MetroSignSelector extends StreetSignSelector {
  ...
  @runtimeProperty("customEditor", "TweakDBGroupInheritance;GenericMetroSign")
  private let m_recordID: TweakDBID;
...
public class HighwaySignSelector extends StreetSignSelector {
  ...
  @runtimeProperty("customEditor", "TweakDBGroupInheritance;GenericHighwaySign")
  private let m_recordID: TweakDBID;
...
public class RaceCheckpointSelector extends StreetSignSelector {
  ...
  @runtimeProperty("customEditor", "TweakDBGroupInheritance;RaceCheckpoint")
  private let m_recordID: TweakDBID;
...
public class CityFluffMessageSelector extends ScreenMessageSelector {
  ...
  @runtimeProperty("customEditor", "TweakDBGroupInheritance;CityFluffScreenMessages.ScreenMessageData")
...
public class QuestMessageSelector extends ScreenMessageSelector {
  ...
  @runtimeProperty("customEditor", "TweakDBGroupInheritance;QuestScreenMessages.ScreenMessageData")
  private persistent let m_recordID: TweakDBID;
