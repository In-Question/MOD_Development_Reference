...
public class GenericMessageNotification extends inkGameController {
  ...
  public final static func Show(controller: ref<worlduiIGameController>, const title: script_ref<String>, const message: script_ref<String>, type: GenericMessageNotificationType) -> ref<inkGameNotificationToken> {
    let data: ref<GenericMessageNotificationData> = GenericMessageNotification.GetBaseData();
    data.title = Deref(title);
    data.message = Deref(message);
    data.type = type;
