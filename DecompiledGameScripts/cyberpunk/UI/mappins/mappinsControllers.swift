...
public abstract native class BaseMappinBaseController extends inkLogicController {
  ...
  protected edit const let m_taggedWidgets: [inkWidgetRef];
  ...
  protected final native func RequestForcedUpdate() -> Void;

  public final native func IsCustomPositionTracked() -> Bool;

  public final native func IsDelamainTaxiTracked() -> Bool;
