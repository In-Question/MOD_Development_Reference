...
public class StatsStreetCredReward extends inkLogicController {
  ...
  public final func SetData(rewardData: [ref<LevelRewardDisplayData>], tooltipsManager: wref<gameuiTooltipsManager>, currentLevel: Int32, tooltipIndex: Int32, const attributeName: script_ref<String>) -> Void {
