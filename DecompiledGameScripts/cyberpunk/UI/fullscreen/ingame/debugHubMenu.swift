...
public class DebugHubMenuLogicController extends inkLogicController {
  ...
  private let m_eventsList: [CName];
  ...
  private final func AddMenuItem(const menuLabel: script_ref<String>, eventName: CName, menuName: CName) -> Void {
    let menuData: MenuData;
    menuData.label = Deref(menuLabel);
    this.m_selectorCtrl.AddValue(Deref(menuLabel));
