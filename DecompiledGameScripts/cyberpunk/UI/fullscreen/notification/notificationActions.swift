...
public class OpenSmsMessengerAction extends GenericNotificationBaseAction {
...
public class OpenPhoneMessageAction extends GenericNotificationBaseAction {
...
public class OpenPerksNotificationAction extends GenericNotificationBaseAction {
  ...
  private final func ShowPerks() -> Void {
    let evt: ref<StartHubMenuEvent> = new StartHubMenuEvent();
    evt.SetStartMenu(n"new_perks");
    this.m_eventDispatcher.QueueBroadcastEvent(evt);
  }
}

public class OpenSkillsNotificationAction extends GenericNotificationBaseAction {
  ...
  private final func ShowSkills() -> Void {
    let userData: ref<OpenSkillsMenuData> = new OpenSkillsMenuData();
    userData.openSkills = true;
    let evt: ref<StartHubMenuEvent> = new StartHubMenuEvent();
    evt.SetStartMenu(n"new_perks", n"skills", userData);
    this.m_eventDispatcher.QueueBroadcastEvent(evt);
  }
}
