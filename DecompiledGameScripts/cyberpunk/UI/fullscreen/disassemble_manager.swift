...
public class DisassembleManager extends gameuiMenuGameController {
  ...
  private let m_popupList: [wref<DisassemblePopupLogicController>];

  private let m_listOfAddedInventoryItems: [InventoryItemData];
...
public class DisassemblePopupLogicController extends inkLogicController {
  ...
  public final func SetupData(const itemData: script_ref<InventoryItemData>) -> Void {
