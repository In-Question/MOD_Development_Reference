...
public class PhotoModeToggle extends inkToggleController {
  ...
  private edit let m_FluffTextWidget: inkTextRef;
  ...
  protected cb func OnInitialize() -> Bool {
    ...
    inkWidgetRef.Get(this.m_FluffTextWidget).BindProperty(n"tintColor", n"MainColors.Red");
  ...
  protected cb func OnToggleChanged(controller: wref<inkToggleController>, isToggled: Bool) -> Bool {
    ...
    if isToggled {
      ...
      inkWidgetRef.Get(this.m_FluffTextWidget).BindProperty(n"tintColor", n"MainColors.Blue");
