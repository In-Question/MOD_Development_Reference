...
public class DropdownListController extends inkLogicController {
  ...
  private let m_data: [ref<DropdownItemData>];
  ...
  public final func Setup(owner: wref<inkLogicController>, const data: script_ref<[ref<DropdownItemData>]>, opt triggerButton: ref<DropdownButtonController>) -> Void {
    this.m_ownerController = owner;
    this.m_triggerButton = triggerButton;
    this.SetupData(data);
  }

  public final func Setup(owner: wref<inkGameController>, const data: script_ref<[ref<DropdownItemData>]>, opt triggerButton: ref<DropdownButtonController>) -> Void {
    this.m_ownerController = owner;
    this.m_triggerButton = triggerButton;
    this.SetupData(data);
  }
  ...
  private final func SetupData(const data: script_ref<[ref<DropdownItemData>]>) -> Void {
    let i: Int32;
  ...
  public final func GetData() -> [ref<DropdownItemData>] {
    return this.m_data;
  }
