...
public class CyberwareAttributesSkills extends inkGameController {
  ...
  private final func HelperGetStatText(currStatType: gamedataStatType, statsSystem: ref<StatsSystem>) -> String {
    let currInt: Int32 = Cast<Int32>(statsSystem.GetStatValue(Cast<StatsObjectID>(this.m_playerPuppet.GetEntityID()), currStatType));
  ...
  protected cb func OnAttributesChange(value: Variant) -> Bool {
    ...
    let attributes: array<SAttribute> = FromVariant<array<SAttribute>>(value);
    let i: Int32 = 0;
  ...
  protected cb func OnDevelopmentPointsChange(value: Variant) -> Bool {
    let developmentPoints: array<SDevelopmentPoints> = FromVariant<array<SDevelopmentPoints>>(value);
    let i: Int32 = 0;
...
public class CyberwareAttributes_Logic extends inkLogicController {
  ...
  public final func SetAttributeValue(const value: script_ref<String>) -> Void {
    let currGraphic: wref<inkImage>;
    inkTextRef.SetText(this.m_textValue, Deref(value));
