...
public abstract final class ItemFilterCategories extends IScriptable {
  ...
  public final static func GetLabelKey(filterType: Int32) -> CName {
    return ItemFilterCategories.GetLabelKey(IntEnum<ItemFilterCategory>(filterType));
  }
  ...
  public final static func GetLabelKey(filterType: ItemFilterCategory) -> CName {
    switch filterType {
      ...
      case ItemFilterCategory.NewWardrobeAppearances:
        return n"UI-Filters-NewWardrobeAppearances";
  ...
  public final static func GetIcon(filterType: Int32) -> String {
    return ItemFilterCategories.GetIcon(IntEnum<ItemFilterCategory>(filterType));
  }
...
public abstract final class ItemFilters extends IScriptable {
  ...
  public final static func GetLabelKey(filterType: Int32) -> CName {
    return ItemFilters.GetLabelKey(IntEnum<ItemFilterType>(filterType));
  }
  ...
  public final static func GetIcon(filterType: Int32) -> String {
    return ItemFilters.GetIcon(IntEnum<ItemFilterType>(filterType));
  }
...
public class ItemCategoryFliterManager extends IScriptable {
  ...
  private let m_filtersToCheck: [ItemFilterCategory];

  private let m_filters: [ItemFilterCategory];

  private let m_sharedFiltersToCheck: [ItemFilterCategory];
  ...
  public final static func Make(opt skipDefaultFilters: Bool) -> ref<ItemCategoryFliterManager> {
    ...
    if !skipDefaultFilters {
      i = 0;
      while i < 10 {
        ArrayPush(instance.m_filtersToCheck, IntEnum<ItemFilterCategory>(i));
        i += 1;
      };
    };
    return instance;
  ...
  public final func AddItem(itemData: wref<gameItemData>) -> Void {
    ...
    while i < ArraySize(this.m_sharedFiltersToCheck) {
      if ItemCategoryFliter.IsOfCategoryType(this.m_sharedFiltersToCheck[i], itemData) {
        if !ArrayContains(this.m_filters, this.m_sharedFiltersToCheck[i]) {
          ArrayPush(this.m_filters, this.m_sharedFiltersToCheck[i]);
        };
        ArrayErase(this.m_sharedFiltersToCheck, i);
    ...
    while i < ArraySize(this.m_filtersToCheck) {
      if ItemCategoryFliter.IsOfCategoryType(this.m_filtersToCheck[i], itemData) {
        if !ArrayContains(this.m_filters, this.m_filtersToCheck[i]) {
  ...
  public final func AddItem(itemCategory: ItemFilterCategory) -> Void {
    let i: Int32 = 0;
    while i < ArraySize(this.m_filtersToCheck) {
      if Equals(this.m_filtersToCheck[i], itemCategory) {
        ArrayPush(this.m_filters, this.m_filtersToCheck[i]);
        ArrayErase(this.m_filtersToCheck, i);
        this.m_isOrderDirty = true;
        return;
      };
      i += 1;
  ...
  public final func Contains(category: ItemFilterCategory) -> Bool {
    return ArrayContains(this.m_filters, category);
  }

  public final func GetFiltersList() -> [ItemFilterCategory] {
  ...
  public final func GetFiltersListSize() -> Int32 {
    return ArraySize(this.m_filters);
  }
  ...
  public final func GetSortedFiltersList() -> [ItemFilterCategory] {
    this.SortFiltersList();
    return this.GetFiltersList();
  }

  public final func GetIntFiltersList() -> [Int32] {
  ...
  public final func GetSortedIntFiltersList() -> [Int32] {
    this.SortFiltersList();
  ...
  public final func Clear(opt skipDefaultFilters: Bool) -> Void {
    ...
    if !skipDefaultFilters {
      i = 0;
      while i < 10 {
        ArrayPush(this.m_filtersToCheck, IntEnum<ItemFilterCategory>(i));
        i += 1;
      };
    };
  }
...
public abstract class ItemCategoryFliter extends IScriptable {
  ...
  public final static func FilterItem(filter: ItemFilterCategory, wrappedData: ref<WrappedInventoryItemData>) -> Bool {
    ...
    if IsDefined(wrappedData.Item) {
      if Equals(filter, ItemFilterCategory.Quest) {
        return wrappedData.Item.IsQuestItem();
      };
      if Equals(filter, ItemFilterCategory.AllItems) {
        return true;
      };
      return Equals(filter, wrappedData.Item.GetFilterCategory());
    };
  ...
  public final static func IsOfCategoryType(filter: ItemFilterCategory, data: wref<gameItemData>) -> Bool {
    ...
    switch filter {
      ...
      case ItemFilterCategory.MeleeWeapons:
        return data.HasTag(n"MeleeWeapon");
      case ItemFilterCategory.Clothes:
  ...
  public final static func GetItemCategoryType(data: wref<UIInventoryItem>) -> ItemFilterCategory {
    let itemType: gamedataItemType;
    let weaponType: WeaponType = data.GetWeaponType();
    if Equals(weaponType, WeaponType.Ranged) {
      return ItemFilterCategory.RangedWeapons;
    };
    if Equals(weaponType, WeaponType.Melee) {
  ...
  public final static func GetItemCategoryType(data: wref<gameItemData>) -> ItemFilterCategory {
    let i: Int32 = 0;
    while i < 10 {
      if ItemCategoryFliter.IsOfCategoryType(IntEnum<ItemFilterCategory>(i), data) {
        return IntEnum<ItemFilterCategory>(i);
      };
      i += 1;
    };
    return ItemFilterCategory.Invalid;
