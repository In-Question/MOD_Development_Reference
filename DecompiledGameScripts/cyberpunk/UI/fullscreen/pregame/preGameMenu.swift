...
public class PreGameSubMenuGameController extends inkGameController {
  ...
  protected final func AddButton(buttonsList: ref<inkVerticalPanel>, const text: script_ref<String>, callBackName: CName) -> Void {
  ...
  protected final func AddBigButton(buttonsList: ref<inkCompoundWidget>, const text: script_ref<String>, callBackName: CName) -> Void {
  ...
  protected final func AddSelector(selectorsList: ref<inkVerticalPanel>, const label: script_ref<String>, opt values: [String]) -> wref<SelectorController> {
