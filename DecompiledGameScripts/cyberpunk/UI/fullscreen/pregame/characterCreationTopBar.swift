...
public class CharacterCreationPersistantElements extends inkLogicController {
  ...
  private let m_headers: [wref<CharacterCreationTopBarHeader>];
  ...
  public final func CreateHeader(const label: script_ref<String>, icon: CName) -> Void {
  ...
  public final func SetFluff(e: ref<inkPointerEvent>) -> Void {
    ...
    inkTextRef.SetText(this.m_fluffTextRight, ToString(Cast<Int32>(value.Y)));
    inkTextRef.SetText(this.m_fluffTextDown, ToString(Cast<Int32>(value.X)));
    inkTextRef.SetText(this.m_fluffTextLeft, ToString(Cast<Int32>(value.Y)));
  }
}
...
public class CharacterCreationTopBarHeader extends inkButtonController {
  ...
  public final func SetData(const label: script_ref<String>, icon: CName) -> Void {
