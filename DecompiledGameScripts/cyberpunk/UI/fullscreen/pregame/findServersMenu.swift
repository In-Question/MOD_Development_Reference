...
public class FindServersMenuGameController extends PreGameSubMenuGameController {
  ...
  protected cb func OnServersSearchResult(servers: [ref<ServerInfo>]) -> Bool {
  ...
  private final func GetButton(buttonsList: wref<inkVerticalPanel>, const name: script_ref<String>) -> wref<inkWidget> {
