...
public class VendorSellJunkPopup extends inkGameController {
  ...
  protected cb func OnInitialize() -> Bool {
    ...
    if Equals(this.m_data.actionType, VendorSellJunkActionType.Sell) {
      inkTextRef.SetText(this.m_itemNameText, "UI-PopupNotification-confirm_sell");
      inkTextRef.SetText(this.m_headerText, "LocKey#53391");
      ...
      if Equals(this.m_data.actionType, VendorSellJunkActionType.Disassemble) {
        inkTextRef.SetText(this.m_headerText, "LocKey#95165");
        fullQuantityParams = new inkTextParams();
        fullQuantityParams.AddNumber("quantity", this.m_data.itemsQuantity);
        inkTextRef.SetText(this.m_sellItemsFullQuantity, "UI-PopupNotification-DisassembleJunkInfo");
        inkTextRef.SetTextParameters(this.m_sellItemsFullQuantity, fullQuantityParams);
        inkWidgetRef.SetVisible(this.m_sellItemsLimitedQuantity, false);
      };
    };
