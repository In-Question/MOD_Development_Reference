...
public class ItemFilterToggleController extends ToggleController {
  ...
  public func GetIcon() -> String {
    if !this.m_useCategoryFilter && Equals(IntEnum<ItemFilterType>(this.m_data), ItemFilterType.Attachments) {
      return "UIIcon.Filter_Mods";
    };
    inkWidgetRef.SetVisible(this.m_newItemDot, this.m_useCategoryFilter && Equals(IntEnum<ItemFilterCategory>(this.m_data), ItemFilterCategory.Buyback));
