  ...
  protected cb func OnCharacterProficiencyUpdated(evt: ref<ProficiencyProgressEvent>) -> Bool {
    switch evt.type {
      ...
      case gamedataProficiencyType.StrengthSkill:
        this.AddToNotificationQueue(evt.expValue, evt.remainingXP, evt.delta, n"Skills", "LocKey#92105", evt.type, evt.currentLevel, evt.isLevelMaxed);
        break;
      case gamedataProficiencyType.ReflexesSkill:
        this.AddToNotificationQueue(evt.expValue, evt.remainingXP, evt.delta, n"Skills", "LocKey#92106", evt.type, evt.currentLevel, evt.isLevelMaxed);
        break;
      case gamedataProficiencyType.TechnicalAbilitySkill:
        this.AddToNotificationQueue(evt.expValue, evt.remainingXP, evt.delta, n"Skills", "LocKey#92108", evt.type, evt.currentLevel, evt.isLevelMaxed);
        break;
      case gamedataProficiencyType.IntelligenceSkill:
        this.AddToNotificationQueue(evt.expValue, evt.remainingXP, evt.delta, n"Skills", "LocKey#92107", evt.type, evt.currentLevel, evt.isLevelMaxed);
        break;
      case gamedataProficiencyType.CoolSkill:
        this.AddToNotificationQueue(evt.expValue, evt.remainingXP, evt.delta, n"Skills", "LocKey#92109", evt.type, evt.currentLevel, evt.isLevelMaxed);
    };
  }

  public final func AddToNotificationQueue(value: Int32, remainingPointsToLevelUp: Int32, delta: Int32, notificationColorTheme: CName, const notificationName: script_ref<String>, type: gamedataProficiencyType, currentLevel: Int32, isLevelMaxed: Bool) -> Void {
...
public class ProgressionNotification extends GenericNotificationController {
  ...
  public func SetNotificationData(notificationData: ref<GenericNotificationViewData>) -> Void {
    ...
    barStartSize = new Vector2(AbsF(this.progression_data.expProgress * this.m_expBarWidthSize - Cast<Float>(this.progression_data.delta)), this.m_expBarHeightSize);
