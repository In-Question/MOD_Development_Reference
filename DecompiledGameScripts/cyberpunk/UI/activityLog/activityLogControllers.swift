...
public class activityLogGameController extends inkHUDGameController {
  ...
  public final func AddNewEntry(const value: script_ref<String>) -> Void {
    let entry: wref<activityLogEntryLogicController>;
  ...
  protected cb func OnNewEntries(value: Variant) -> Bool {
    let newEntries: array<String> = FromVariant<array<String>>(value);
...
public class activityLogEntryLogicController extends inkLogicController {
  ...
  public final func SetText(const displayText: script_ref<String>) -> Void {
    ...
    this.m_displayText = Deref(displayText);
    this.m_originalSize = Cast<Uint16>(StrLen(this.m_displayText));
    ...
    typingAnimPlaybackOptions.loopCounter = Cast<Uint32>(this.m_originalSize + 1u);
  ...
  protected cb func OnTyping(proxy: ref<inkAnimProxy>) -> Bool {
    let nextSymbol: String = StrMid(this.m_displayText, Cast<Int32>(this.m_originalSize - this.m_size), 1);
    this.m_root.SetLetterCase(textLetterCase.UpperCase);
