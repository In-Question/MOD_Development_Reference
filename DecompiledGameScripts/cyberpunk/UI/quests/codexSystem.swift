...
public class CodexSystem extends ScriptableSystem {
  ...
  private let m_codex: [SCodexRecord];
  ...
  public final const func GetCodex() -> [SCodexRecord] {
    return this.m_codex;
  }

  public final const func GetCodexRecordParts(recordTweak: TweakDBID) -> [SCodexRecordPart] {
