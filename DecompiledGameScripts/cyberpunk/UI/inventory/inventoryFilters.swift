...
public class InventoryFilterButton extends BaseButtonView {
  ...
  public final func Setup(const text: script_ref<String>, input: CName, framesDelay: Int32) -> Void {
  ...
  public final func Setup(const text: script_ref<String>, input: CName) -> Void {
