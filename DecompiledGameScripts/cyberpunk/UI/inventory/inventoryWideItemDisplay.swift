...
public class InventoryWideItemDisplay extends InventoryItemDisplay {
  ...
  public func Setup(const itemData: script_ref<InventoryItemData>, additionalInfo: ItemAdditionalInfoType) -> Void {
    this.Setup(itemData);
  ...
  protected func GetDPS(const data: script_ref<InventoryItemData>) -> Int32 {
    let i: Int32;
    let limit: Int32;
