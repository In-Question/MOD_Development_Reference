...
public class InventoryItemDisplayCategoryArea extends inkLogicController {
  ...
  protected edit const let m_areasToHide: [inkWidgetRef];

  protected edit const let m_equipmentAreas: [inkCompoundRef];

  protected edit let m_newItemsWrapper: inkWidgetRef;

  protected edit let m_newItemsCounter: inkTextRef;

  protected let m_categoryAreas: [wref<InventoryItemDisplayEquipmentArea>];
  ...
  public final func GetAreasToHide() -> [inkWidgetRef] {
    return this.m_areasToHide;
  }

  public final func GetCategoryAreas() -> [wref<InventoryItemDisplayEquipmentArea>] {
...
public class InventoryItemDisplayEquipmentArea extends inkLogicController {
  ...
  protected edit const let m_equipmentAreas: [gamedataEquipmentArea];

  protected edit let m_numberOfSlots: Int32;

  public final static func GetEquipmentAreaByName(const categoryName: script_ref<String>) -> gamedataEquipmentArea {
    switch Deref(categoryName) {
      case "Head":
