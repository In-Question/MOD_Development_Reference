...
public abstract class QuicksortTemplate extends IScriptable {
  ...
  public final static func Sort(items: script_ref<[Variant]>, comparator: ref<SortComparatorTemplate>, leftIndex: Int32, rightIndex: Int32) -> Void {
    let index: Int32;
  ...
  private final static func Partition(items: script_ref<[Variant]>, comparator: ref<SortComparatorTemplate>, leftIndex: Int32, rightIndex: Int32) -> Int32 {
    let tempItem: Variant;
    let i: Int32 = leftIndex;
    let j: Int32 = rightIndex;
    let pivot: Variant = Deref(items)[FloorF(Cast<Float>(rightIndex) + Cast<Float>(leftIndex) / 2.00)];
    while i <= j {
...
public class QuicksortInt extends IScriptable {
  ...
  public final static func Sort(items: script_ref<[Int32]>, comparator: ref<IntComparator>, leftIndex: Int32, rightIndex: Int32) -> Void {
    let index: Int32;
    if ArraySize(Deref(items)) > 1 {
  ...
  private final static func Partition(items: script_ref<[Int32]>, comparator: ref<IntComparator>, leftIndex: Int32, rightIndex: Int32) -> Int32 {
    let tempItem: Int32;
    let i: Int32 = leftIndex;
    let j: Int32 = rightIndex;
    let pivot: Int32 = Deref(items)[FloorF((Cast<Float>(rightIndex) + Cast<Float>(leftIndex)) / 2.00)];
    while i <= j {
...
public class QuicksortInventoryItemData extends IScriptable {
  ...
  public final static func Sort(items: script_ref<[InventoryItemData]>, comparator: ref<InventoryItemDataComparator>, leftIndex: Int32, rightIndex: Int32) -> Void {
    let index: Int32;
    if ArraySize(Deref(items)) > 1 {
  ...
  private final static func Partition(items: script_ref<[InventoryItemData]>, comparator: ref<InventoryItemDataComparator>, leftIndex: Int32, rightIndex: Int32) -> Int32 {
    let tempItem: InventoryItemData;
    let i: Int32 = leftIndex;
    let j: Int32 = rightIndex;
    let pivot: InventoryItemData = Deref(items)[FloorF((Cast<Float>(rightIndex) + Cast<Float>(leftIndex)) / 2.00)];
    while i <= j {
      while comparator.Compare(Deref(items)[i], pivot) > 0 {
        i += 1;
      };
...
public class InventoryItemDataComparator extends IScriptable {
  ...
  public func Compare(const left: script_ref<InventoryItemData>, const right: script_ref<InventoryItemData>) -> Int32 {
    return 0;
  }
}
