...
public class hudCarRaceController extends inkHUDGameController {
  ...
  protected cb func OnVehicleForwardRaceClockUpdateEvent(evt: ref<VehicleForwardRaceClockUpdateEvent>) -> Bool {
    ...
    let second: Int32 = Cast<Int32>(engineTimeFloat) - minutes * 60;
    let millisecondFloat: Float = engineTimeFloat - Cast<Float>(second) - Cast<Float>(minutes) * 60.00;
    let millisecond: Int32 = Cast<Int32>(millisecondFloat * 100.00);
