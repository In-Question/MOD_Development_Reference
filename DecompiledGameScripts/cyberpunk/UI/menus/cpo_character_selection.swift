...
public class CpoCharacterButtonItemController extends inkButtonDpadSupportedController {
  ...
  public final func SetButtonDetails(const text: script_ref<String>, characterRecordId: TweakDBID) -> Void {
    ...
    currListText.SetText(Deref(text));
...
public class CpoCharacterSelectionWidgetGameController extends inkGameController {
  ...
  private final func CreateCharacterButton(parent: wref<inkHorizontalPanel>, const argText: script_ref<String>, characterRecordId: TweakDBID) -> Void {
