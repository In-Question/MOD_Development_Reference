...
public class hudButtonReminderGameController extends inkHUDGameController {
  ...
  private final func OnRedrawText_1(const argValue: script_ref<String>) -> Void {
    (inkCompoundRef.GetWidget(this.m_Button1, n"buttonText") as inkText).SetText(Deref(argValue));
    inkWidgetRef.SetVisible(this.m_Button1, Cast<Bool>(StrLen(argValue)));
  }
  ...
  private final func OnRedrawText_2(const argValue: script_ref<String>) -> Void {
    (inkCompoundRef.GetWidget(this.m_Button2, n"buttonText") as inkText).SetText(Deref(argValue));
    inkWidgetRef.SetVisible(this.m_Button2, Cast<Bool>(StrLen(argValue)));
  }
  ...
  private final func OnRedrawText_3(const argValue: script_ref<String>) -> Void {
    (inkCompoundRef.GetWidget(this.m_Button3, n"buttonText") as inkText).SetText(Deref(argValue));
    inkWidgetRef.SetVisible(this.m_Button3, Cast<Bool>(StrLen(argValue)));
  }
