...
public class BaseModalListPopupGameController extends inkGameController {
  ...
  @default(BaseModalListPopupGameController, radialMenu)
  protected let m_timeDilationProfile: String;

  @default(BaseModalListPopupGameController, false)
  protected let m_canPlaySwitchAnimation: Bool;
  ...
  private let m_inoutTransitionAnimProxy: ref<inkAnimProxy>;
  ...
  protected cb func OnInitialize() -> Bool {
    ...
    this.SetupTimeModifierConfig();
    this.SetTimeDilatation(true);
    this.BaseSetupVirtualList();
    this.m_inoutTransitionAnimProxy = this.PlayLibraryAnimation(n"fadeIn");
    this.m_inoutTransitionAnimProxy.RegisterToCallback(inkanimEventType.OnFinish, this, n"OnShowAnimFinished");
  ...
  protected cb func OnUninitialize() -> Bool {
    ...
    this.m_canPlaySwitchAnimation = false;
  }
  ...
  protected cb func OnPlayerAttach(playerPuppet: ref<GameObject>) -> Bool {
    ...
    this.SetupData();
    playerControlledObject.RegisterInputListener(this, n"popup_moveUp_left_stick_up");
    playerControlledObject.RegisterInputListener(this, n"popup_moveUp_left_stick_down");
  ...
  protected cb func OnAction(action: ListenerAction, consumer: ListenerActionConsumer) -> Bool {
    ...
    if IsDefined(this.m_inoutTransitionAnimProxy) && this.m_inoutTransitionAnimProxy.IsValid() {
      return true;
    };
    if Equals(actionType, gameinputActionType.REPEAT) {
      ...
      if Equals(actionType, gameinputActionType.BUTTON_RELEASED) && Equals(actionName, n"proceed") {
        this.Activate();
      } else {
  ...
  protected cb func OnItemSelected(previous: ref<inkVirtualCompoundItemController>, next: ref<inkVirtualCompoundItemController>) -> Bool {
    ...
    if this.m_canPlaySwitchAnimation {
  ...
  protected final func Close() -> Void {
    this.m_inoutTransitionAnimProxy = this.PlayLibraryAnimation(n"fadeOut");
    this.m_inoutTransitionAnimProxy.RegisterToCallback(inkanimEventType.OnFinish, this, n"OnHideAnimFinished");
    this.OnClose();
  }
