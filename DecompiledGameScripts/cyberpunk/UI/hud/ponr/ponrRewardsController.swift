...
public class PonrRewardsGameController extends BaseModalListPopupGameController {
  ...
  private final func InventoryItemHoverOver(const itemData: script_ref<InventoryItemData>, widget: wref<inkWidget>) -> Void {
  ...
  private final func PopulateData() -> Void {
    ...
    let itemDataArray: array<ItemID> = FromVariant<array<ItemID>>(this.m_pointOfNoReturnBB.GetVariant(this.m_pointOfNoReturnRewardScreenDef.Rewards));
