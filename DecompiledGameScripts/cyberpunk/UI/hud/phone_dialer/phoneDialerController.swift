...
public class PhoneDialerGameController extends gameuiNewPhoneRelatedHUDGameController {
  ...
  private final func PopulateData() -> Void {
    let contactDataArray: array<ref<IScriptable>> = this.m_journalManager.GetContactDataArray(false, false);
