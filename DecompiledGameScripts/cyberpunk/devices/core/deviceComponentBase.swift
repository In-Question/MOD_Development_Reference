...
public class ScriptableDeviceComponent extends DeviceComponent {

  public const func GetPS() -> ref<ScriptableDeviceComponentPS> {
    return this.GetBasePS() as ScriptableDeviceComponentPS;
  }
...
public class SharedGameplayPS extends DeviceComponentPS {
  ...
  @default(ConveyorControllerPS, EDeviceStatus.OFF)
  @default(ScriptableDeviceComponentPS, EDeviceStatus.ON)
  @default(ServerNodeControllerPS, EDeviceStatus.ON)
  ...
  public final const func IsConnectedToSecuritySystem() -> Bool {
    let securitySystem: ref<SecuritySystemControllerPS> = this.GetSecuritySystem();
    return IsDefined(securitySystem);
  }
  ...
  protected final const func FindHighestSecurityAccessLevel(const securityAreas: script_ref<[ref<SecurityAreaControllerPS>]>) -> ESecurityAccessLevel {
    let highestLevel: ESecurityAccessLevel = ESecurityAccessLevel.ESL_NONE;
    let i: Int32 = 0;
    while i < ArraySize(Deref(securityAreas)) {
      if EnumInt(Deref(securityAreas)[i].GetSecurityAccessLevel()) > EnumInt(highestLevel) {
        highestLevel = Deref(securityAreas)[i].GetSecurityAccessLevel();
      };
      i += 1;
    };
  ...
  public const func HasNetworkBackdoor() -> Bool {
    ...
    if this.m_hasNetworkBackdoor && EnumInt(this.GetDeviceState()) > -1 {
  ...
  public final const func GetAccessPoints() -> [ref<AccessPointControllerPS>] {
    let ap: ref<AccessPointControllerPS>;
    let aps: array<ref<AccessPointControllerPS>>;
    let i: Int32;
    let parents: array<ref<DeviceComponentPS>>;
...
public native class DeviceComponentPS extends GameComponentPS {
  ...
  @default(DeviceComponentPS, gamedataComputerUIStyle.LightBlue)
  protected let m_deviceUIStyle: gamedataComputerUIStyle;
  ...
  protected final func ProcessDevicesLazy(const lazyDevices: script_ref<[ref<LazyDevice>]>, opt eventToSendOnCompleted: ref<ProcessDevicesEvent>) -> Void {
    let evt: ref<ExtractDevicesEvent> = new ExtractDevicesEvent();
    evt.lazyDevices = Deref(lazyDevices);
  ...
  public final native func GetNativeActions(out outActions: [ref<DeviceAction>], context: GetActionsContext) -> Void;
  ...
  public final func GetActionsToNative(context: GetActionsContext) -> [ref<DeviceAction>] {
    let actions: array<ref<DeviceAction>>;
    this.GetActions(actions, context);
    return actions;
  }

  public final func GetQuestActionsToNative(context: GetActionsContext) -> [ref<DeviceAction>] {
    let actions: array<ref<DeviceAction>>;
  ...
  public const func GetSecurityAreas(opt includeInactive: Bool, opt returnOnlyDirectlyConnected: Bool) -> [ref<SecurityAreaControllerPS>] {
  ...
  public const func GetChildren(out outDevices: [ref<DeviceComponentPS>]) -> Void {
    GameInstance.GetDeviceSystem(this.GetGameInstance()).GetChildren(this.GetMyEntityID(), outDevices);
  }

  public const func GetLazyChildren(out outDevices: [ref<LazyDevice>]) -> Void {
  ...
  public const func GetLazyParents() -> [ref<LazyDevice>] {
  ...
  public const func GetAncestors(out outDevices: [ref<DeviceComponentPS>]) -> Void {
    GameInstance.GetDeviceSystem(this.GetGameInstance()).GetAllAncestors(this.GetMyEntityID(), outDevices);
  }

  public const func GetLazyAncestors() -> [ref<LazyDevice>] {
  ...
  protected func GetInkWidgetLibraryID(const context: script_ref<GetActionsContext>) -> CName {
    return n"None";
  }
