...
public class WeakFence extends InteractiveDevice {
  ...
  protected const func GetController() -> ref<WeakFenceController> {
    return this.m_controller as WeakFenceController;
  }

  public const func GetDevicePS() -> ref<WeakFenceControllerPS> {
