...
public class DeviceWidgetControllerBase extends DeviceInkLogicControllerBase {
  ...
  protected final func CreateActionWidget(gameController: ref<DeviceInkGameControllerBase>, parentWidget: wref<inkWidget>, const widgetData: script_ref<SActionWidgetPackage>) -> wref<inkWidget> {
    let screenDef: ScreenDefinitionPackage = gameController.GetScreenDefinition();
    let widget: ref<inkWidget> = gameController.FindWidgetInLibrary(parentWidget, TweakDBInterface.GetWidgetDefinitionRecord(Deref(widgetData).widgetTweakDBID), screenDef.screenDefinition.TerminalScreenType(), screenDef.style, Deref(widgetData).libraryID, Deref(widgetData).libraryPath);
    if widget != null {
      widget.SetSizeRule(inkESizeRule.Stretch);
    };
    return widget;
  ...
  protected final func GetActionWidget(const widgetData: script_ref<SActionWidgetPackage>, gameController: ref<DeviceInkGameControllerBase>) -> wref<inkWidget> {
    let index: Int32 = this.GetActionWidgetDataIndex(Deref(widgetData), gameController);
  ...
  protected final func HasActionWidgetData(const widgetData: script_ref<SActionWidgetPackage>, gameController: ref<DeviceInkGameControllerBase>) -> Bool {
    return this.GetActionWidgetDataIndex(Deref(widgetData), gameController) >= 0;
  }

  protected final func HasActionWidget(const widgetData: script_ref<SActionWidgetPackage>, gameController: ref<DeviceInkGameControllerBase>) -> Bool {
  ...
  protected final func InitializeActionWidget(gameController: ref<DeviceInkGameControllerBase>, widget: ref<inkWidget>, const widgetData: script_ref<SActionWidgetPackage>) -> Void {
  ...
  protected final func RegisterButtonWidgetToAudioCallbacks(gameController: ref<DeviceInkGameControllerBase>, widget: ref<inkWidget>) -> Void {
    let controller: ref<DeviceButtonLogicControllerBase> = widget.GetController() as DeviceButtonLogicControllerBase;
    if controller != null {
