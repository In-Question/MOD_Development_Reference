...
public class BackdoorInkGameController extends MasterDeviceInkGameControllerBase {
  ...
  protected func RegisterBlackboardCallbacks(blackboard: ref<IBlackboard>) -> Void {
    ...
    if IsDefined(blackboard) {
      ...
      this.m_onIsInDefaultStateListener = blackboard.RegisterListenerBool(this.GetOwner().GetBlackboardDef().isInDefaultState, this, n"OnIsInDefaultState");
      this.m_onShutdownModuleListener = blackboard.RegisterListenerInt(this.GetOwner().GetBlackboardDef().shutdownModule, this, n"OnShutdownModule");
      this.m_onBootModuleListener = blackboard.RegisterListenerInt(this.GetOwner().GetBlackboardDef().bootModule, this, n"OnBootModule");
    };
  }
  ...
  protected func UnRegisterBlackboardCallbacks(blackboard: ref<IBlackboard>) -> Void {
    ...
    if IsDefined(blackboard) {
      ...
      blackboard.UnregisterListenerBool(this.GetOwner().GetBlackboardDef().isInDefaultState, this.m_onIsInDefaultStateListener);
      blackboard.UnregisterListenerInt(this.GetOwner().GetBlackboardDef().shutdownModule, this.m_onShutdownModuleListener);
      blackboard.UnregisterListenerInt(this.GetOwner().GetBlackboardDef().bootModule, this.m_onBootModuleListener);
    };
  }
  ...
  protected func GetOwner() -> ref<AccessPoint> {
    return this.GetOwnerEntity() as AccessPoint;
  }
