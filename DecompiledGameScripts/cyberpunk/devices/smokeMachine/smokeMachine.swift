...
public class SmokeMachine extends BasicDistractionDevice {
  ...
  protected let m_entities: [wref<Entity>];
  ...
  public const func GetDevicePS() -> ref<SmokeMachineControllerPS> {
    return this.GetController().GetPS();
  }

  private const func GetController() -> ref<SmokeMachineController> {
    return this.m_controller as SmokeMachineController;
  }
