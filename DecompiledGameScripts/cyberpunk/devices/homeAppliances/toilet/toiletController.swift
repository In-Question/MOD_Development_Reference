...
public class ToiletController extends ScriptableDeviceComponent {

  public const func GetPS() -> ref<ToiletControllerPS> {
    return this.GetBasePS() as ToiletControllerPS;
  }
}
