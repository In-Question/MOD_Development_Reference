...
public class DisplayGlassController extends ScriptableDeviceComponent {

  public const func GetPS() -> ref<DisplayGlassControllerPS> {
    return this.GetBasePS() as DisplayGlassControllerPS;
  }
}
...
public class DisplayGlassControllerPS extends ScriptableDeviceComponentPS {
  ...
  public func GetQuestActionByName(actionName: CName) -> ref<DeviceAction> {
    ...
    if action == null {
      switch actionName {
        case n"QuestForceTintGlass":
          action = this.ActionQuestForceTintGlass();
          break;
        case n"QuestForceClearGlass":
          action = this.ActionQuestForceClearGlass();
      };
    };
    return action;
  }
