...
public class MediaDeviceStatus extends BaseDeviceStatus {
  ...
  public final static func IsDefaultConditionMet(device: ref<ScriptableDeviceComponentPS>, const context: script_ref<GetActionsContext>) -> Bool {
    if MediaDeviceStatus.IsAvailable(device) && MediaDeviceStatus.IsClearanceValid(Deref(context).clearance) {
      return true;
    };
    return false;
  }
...
public class NextStation extends ActionBool {
  ...
  public final static func IsDefaultConditionMet(device: ref<ScriptableDeviceComponentPS>, const context: script_ref<GetActionsContext>) -> Bool {
    if NextStation.IsAvailable(device) && NextStation.IsClearanceValid(Deref(context).clearance) {
      return true;
    };
    return false;
  }
...
public class QuestNextStation extends ActionBool {

  public final func SetProperties() -> Void {
    this.actionName = n"QuestNextStation";
    this.prop = DeviceActionPropertyFunctions.SetUpProperty_Bool(this.actionName, true, n"QuestNextStation", n"QuestNextStation");
  }
}
...
public class PreviousStation extends ActionBool {
  ...
  public final static func IsDefaultConditionMet(device: ref<ScriptableDeviceComponentPS>, const context: script_ref<GetActionsContext>) -> Bool {
    if PreviousStation.IsAvailable(device) && PreviousStation.IsClearanceValid(Deref(context).clearance) {
      return true;
    };
    return false;
  }
...
public class QuestPreviousStation extends ActionBool {

  public final func SetProperties() -> Void {
    this.actionName = n"QuestPreviousStation";
    this.prop = DeviceActionPropertyFunctions.SetUpProperty_Bool(this.actionName, true, n"QuestPreviousStation", n"QuestPreviousStation");
  }
}

public class QuestDefaultStation extends ActionBool {

  public final func SetProperties() -> Void {
    this.actionName = n"QuestDefaultStation";
    this.prop = DeviceActionPropertyFunctions.SetUpProperty_Bool(this.actionName, true, n"QuestDefaultStation", n"QuestDefaultStation");
  }
}
...
public class QuickHackAoeDamage extends ActionBool {

  public final func SetProperties() -> Void {
    this.actionName = n"QuickHackAoeDamage";
    this.prop = DeviceActionPropertyFunctions.SetUpProperty_Bool(this.actionName, true, this.actionName, this.actionName);
  }
}

public class QuickHackHighPitchNoise extends ActionBool {

  public final func SetProperties() -> Void {
    this.actionName = n"QuickHackHighPitchNoise";
    this.prop = DeviceActionPropertyFunctions.SetUpProperty_Bool(this.actionName, true, this.actionName, this.actionName);
  }
}
...
public class GlitchScreen extends ActionBool {
  ...
  public final static func IsDefaultConditionMet(device: ref<ScriptableDeviceComponentPS>, const context: script_ref<GetActionsContext>) -> Bool {
    if GlitchScreen.IsAvailable(device) && GlitchScreen.IsClearanceValid(Deref(context).clearance) {
      return true;
    };
    return false;
  }
