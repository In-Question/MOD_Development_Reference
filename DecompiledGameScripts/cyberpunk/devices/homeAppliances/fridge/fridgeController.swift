...
public class FridgeController extends ScriptableDeviceComponent {

  public const func GetPS() -> ref<FridgeControllerPS> {
    return this.GetBasePS() as FridgeControllerPS;
  }
}
