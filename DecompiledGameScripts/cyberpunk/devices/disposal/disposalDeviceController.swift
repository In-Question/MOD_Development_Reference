...
public class ActionDisposal extends ActionBool {
  ...
  public func CompleteAction(gameInstance: GameInstance) -> Void {
    ...
    while i < ArraySize(rewards) {
      RPGManager.GiveReward(gameInstance, rewards[i].GetID(), Cast<StatsObjectID>(mountingInfo.childId));
      i += 1;
    };
...
public class DisposalDeviceController extends ScriptableDeviceComponent {

  public const func GetPS() -> ref<DisposalDeviceControllerPS> {
    return this.GetBasePS() as DisposalDeviceControllerPS;
  }
}
...
public class DisposalDeviceControllerPS extends ScriptableDeviceComponentPS {
  ...
  public final func GetExplosionDeinitionArray() -> [ExplosiveDeviceResourceDefinition] {
  ...
  protected func GetSkillCheckContainerForSetup() -> ref<BaseSkillCheckContainer> {
    return this.m_distractionSetup.m_skillChecks;
  }
  ...
  protected final func ActionSpiderbotDistraction(const interactionName: script_ref<String>) -> ref<SpiderbotDistraction> {
  ...
  protected final func ActionSpiderbotExplosion(const interactionName: script_ref<String>) -> ref<SpiderbotExplodeExplosiveDevice> {
  ...
  public final const func IsEnemyGrappled() -> Bool {
    return this.GetPlayerSMBlackboard().GetInt(GetAllBlackboardDefs().PlayerStateMachine.Takedown) == 2;
  }

  protected final func IsPlayerDroppingBody() -> Bool {
    return this.GetPlayerSMBlackboard().GetInt(GetAllBlackboardDefs().PlayerStateMachine.BodyCarrying) == 4;
  }
