...
public class MovableDevice extends InteractiveDevice {
  ...
  protected edit const let m_offMeshConnectionsToOpenNames: [CName];

  protected let m_offMeshConnectionsToOpen: [ref<OffMeshConnectionComponent>];

  protected let m_additionalMeshComponent: ref<MeshComponent>;

  @runtimeProperty("tooltip", "If set to true, the position of the WorkspotResourceComponent containing the player workspot will be used for the player during sync animations.")
