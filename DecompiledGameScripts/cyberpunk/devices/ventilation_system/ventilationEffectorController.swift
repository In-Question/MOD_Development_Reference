...
public class VentilationEffectorController extends ScriptableDeviceComponent {

  public const func GetPS() -> ref<VentilationEffectorControllerPS> {
    return this.GetBasePS() as VentilationEffectorControllerPS;
  }
}
