...
public class SmartHouseController extends MasterController {
  ...
  public const func GetPS() -> ref<SmartHouseControllerPS> {
    return this.GetBasePS() as SmartHouseControllerPS;
  }
}

public class SmartHouseControllerPS extends MasterControllerPS {

  protected let m_timetable: [SPresetTimetableEntry];

  protected inline let m_activePreset: ref<SmartHousePreset>;

  protected inline const let m_availablePresets: [ref<SmartHousePreset>];
