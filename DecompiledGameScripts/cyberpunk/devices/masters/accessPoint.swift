...
public class AccessPoint extends InteractiveMasterDevice {
  ...
  protected const func GetController() -> ref<AccessPointController> {
    return this.m_controller as AccessPointController;
  }

  public const func GetDevicePS() -> ref<AccessPointControllerPS> {
  ...
  protected cb func OnDebugRemoteConnectionEvent(evt: ref<DebugRemoteConnectionEvent>) -> Bool {
    this.GetDevicePS().DebugBreachConnectedDevices();
  }
  ...
  private final func UploadProgram() -> Void {
    ...
    this.GetDevicePS().UploadProgram(programID);
  }
