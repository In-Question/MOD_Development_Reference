...
public class Terminal extends InteractiveMasterDevice {
  ...
  private const func GetController() -> ref<TerminalController> {
    return this.m_controller as TerminalController;
  }

  public const func GetDevicePS() -> ref<TerminalControllerPS> {
  ...
  public const func ShouldShowTerminalTitle() -> Bool {
    return this.GetDevicePS().ShouldShowTerminalTitle();
  }
