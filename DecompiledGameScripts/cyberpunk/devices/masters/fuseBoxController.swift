...
public class FuseBoxController extends MasterController {
  ...
  public const func GetPS() -> ref<FuseBoxControllerPS> {
    return this.GetBasePS() as FuseBoxControllerPS;
  }
}
...
public class FuseBoxControllerPS extends MasterControllerPS {
  ...
  @runtimeProperty("tooltip", "Generator has spiderbot action to overload given device")
  ...
  protected func GetSkillCheckContainerForSetup() -> ref<BaseSkillCheckContainer> {
    return this.m_fuseBoxSkillChecks;
  }
  ...
  protected func ActionEngineering(const context: script_ref<GetActionsContext>) -> ref<ActionEngineering> {
    ...
    action.CreateInteraction(Deref(context).processInitiatorObject, "Open");
    return action;
  }
  ...
  private final func RefreshSlaves(devices: [ref<DeviceComponentPS>]) -> Void {
  ...
  protected func GetSpiderbotActions(actions: script_ref<[ref<DeviceAction>]>, const context: script_ref<GetActionsContext>) -> Void {
    ...
    ArrayPush(Deref(actions), this.ActionSendSpiderbotToOverloadDevice());
    if this.HasAnySlave() {
      ArrayPush(Deref(actions), this.ActionSendSpiderbotToTogglePower());
    };
  }
