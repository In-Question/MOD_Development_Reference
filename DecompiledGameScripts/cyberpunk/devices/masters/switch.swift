...
public class SimpleSwitch extends InteractiveMasterDevice {
  ...
  private const func GetController() -> ref<SimpleSwitchController> {
    return this.m_controller as SimpleSwitchController;
  }

  public const func GetDevicePS() -> ref<SimpleSwitchControllerPS> {
