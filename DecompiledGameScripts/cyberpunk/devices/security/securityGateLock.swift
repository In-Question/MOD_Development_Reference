...
public class SecurityGateLock extends InteractiveDevice {
  ...
  public const func GetDevicePS() -> ref<SecurityGateLockControllerPS> {
    return this.GetController().GetPS();
  }

  private const func GetController() -> ref<SecurityGateLockController> {
    return this.m_controller as SecurityGateLockController;
  }
