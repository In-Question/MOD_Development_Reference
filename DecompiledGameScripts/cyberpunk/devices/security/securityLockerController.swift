...
public class SecurityLockerController extends ScriptableDeviceComponent {

  public const func GetPS() -> ref<SecurityLockerControllerPS> {
    return this.GetBasePS() as SecurityLockerControllerPS;
  }
}
