...
public class BlindingLight extends BasicDistractionDevice {
  ...
  protected func StartDistraction(opt loopAnimation: Bool) -> Void {
    ...
    this.StartBlinking();
    GameObject.PlaySoundEvent(this, this.GetDevicePS().GetDistractionSound());
  ...
  protected func TurnOnDevice() -> Void {
    this.TurnOnLights();
    GameObject.PlaySoundEvent(this, this.GetDevicePS().GetTurnOnSound());
  }

  protected func TurnOffDevice() -> Void {
    this.TurnOffLights();
    GameObject.PlaySoundEvent(this, this.GetDevicePS().GetTurnOffSound());
  }
  ...
  private const func GetController() -> ref<BlindingLightController> {
    return this.m_controller as BlindingLightController;
  }

  public const func GetDevicePS() -> ref<BlindingLightControllerPS> {
