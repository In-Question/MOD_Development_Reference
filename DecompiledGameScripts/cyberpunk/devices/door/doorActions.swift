...
public class Pay extends ActionBool {
  ...
  public final static func IsDefaultConditionMet(device: ref<DoorControllerPS>, const context: script_ref<GetActionsContext>) -> Bool {
    if Pay.IsAvailable(device) && Pay.IsClearanceValid(Deref(context).clearance) {
      return true;
    };
    return false;
  }
...
public class QuickHackToggleOpen extends ActionBool {
  ...
  public final static func IsDefaultConditionMet(device: ref<DoorControllerPS>, const context: script_ref<GetActionsContext>) -> Bool {
    if QuickHackToggleOpen.IsAvailable(device, Deref(context).processInitiatorObject.IsPlayer()) && QuickHackToggleOpen.IsClearanceValid(Deref(context).clearance) {
      return true;
    };
    return false;
  }

  public final static func IsAvailable(device: ref<DoorControllerPS>, isPlayerRequest: Bool) -> Bool {
...
public class DoorStatus extends BaseDeviceStatus {
  ...
  public final static func IsDefaultConditionMet(device: ref<ScriptableDeviceComponentPS>, const context: script_ref<GetActionsContext>) -> Bool {
    if DoorStatus.IsAvailable(device) && DoorStatus.IsClearanceValid(Deref(context).clearance) {
      return true;
    };
    return false;
  }
...
public class DoorOpeningToken extends ActionBool {
  ...
  public final static func IsAvailable(device: ref<DoorControllerPS>) -> Bool {
    return ScriptableDeviceAction.IsAvailable(device);
  }
...
public class ToggleOpen extends ActionBool {
  ...
  public final static func IsDefaultConditionMet(device: ref<DoorControllerPS>, const context: script_ref<GetActionsContext>) -> Bool {
    if ToggleOpen.IsAvailable(device, Deref(context).processInitiatorObject.IsPlayer()) && ToggleOpen.IsClearanceValid(Deref(context).clearance) {
      return true;
    };
    return false;
  }
...
public class SetOpened extends ActionBool {
  ...
  public final static func IsDefaultConditionMet(device: ref<DoorControllerPS>, const context: script_ref<GetActionsContext>) -> Bool {
    if SetOpened.IsAvailable(device, Deref(context).processInitiatorObject.IsPlayer()) && SetOpened.IsClearanceValid(Deref(context).clearance) {
      return true;
    };
    return false;
  }
...
public class SetClosed extends ActionBool {
  ...
  public final static func IsDefaultConditionMet(device: ref<DoorControllerPS>, const context: script_ref<GetActionsContext>) -> Bool {
    if SetClosed.IsAvailable(device) && SetClosed.IsClearanceValid(Deref(context).clearance) {
      return true;
    };
    return false;
  }
...
public class ToggleLock extends ActionBool {
  ...
  public final static func IsDefaultConditionMet(device: ref<DoorControllerPS>, const context: script_ref<GetActionsContext>) -> Bool {
    if ToggleLock.IsAvailable(device, Deref(context).requestType) && ToggleLock.IsClearanceValid(Deref(context).clearance) {
      return true;
    };
    return false;
  }
...
public class ToggleSeal extends ActionBool {
  ...
  public final static func IsDefaultConditionMet(device: ref<DoorControllerPS>, const context: script_ref<GetActionsContext>) -> Bool {
    if ToggleSeal.IsAvailable(device) && ToggleSeal.IsClearanceValid(Deref(context).clearance) {
      return true;
    };
    return false;
  }
  ...
  public final static func IsClearanceValid(clearance: ref<Clearance>) -> Bool {
    if Clearance.IsInRange(clearance, 8) {
      return true;
    };
    return false;
  }
...
public class ForceOpen extends ActionBool {
  ...
  public final static func IsDefaultConditionMet(device: ref<DoorControllerPS>, const context: script_ref<GetActionsContext>) -> Bool {
    if ForceOpen.IsAvailable(device) && ForceOpen.IsClearanceValid(Deref(context).clearance) {
      return true;
    };
    return false;
  }
...
public class PlayerUnauthorized extends ActionBool {
  ...
  public final func CreateInteraction(device: ref<DoorControllerPS>, opt actions: [ref<DeviceAction>]) -> Void {
  ...
  public final static func IsDefaultConditionMet(device: ref<DoorControllerPS>, const context: script_ref<GetActionsContext>) -> Bool {
    if PlayerUnauthorized.IsAvailable(device) && PlayerUnauthorized.IsClearanceValid(Deref(context).clearance) {
      return true;
    };
    return false;
  }
...
public class QuestForceClose extends ActionFloat {
  ...
  public final func SetProperties(speedMultiplier: Float) -> Void {
    this.actionName = n"ForceClose";
    this.prop = DeviceActionPropertyFunctions.SetUpProperty_Float(n"ClosingSpeedMultiplier", speedMultiplier);
  }

  public final func GetValue() -> Float {
    return FromVariant<Float>(this.prop.first);
  }
}
