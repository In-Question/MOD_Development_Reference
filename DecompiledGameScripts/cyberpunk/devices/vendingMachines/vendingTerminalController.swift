...
public class CraftItemForTarget extends ActionBool {
  ...
  public final func CreateActionWidgetPackage(const displayText: script_ref<String>, const additionalText: script_ref<String>, imageAtlasImageID: CName, opt actions: [ref<DeviceAction>]) -> Void {
    ...
    this.m_actionWidgetPackage.widgetName = Deref(displayText);
...
public class VendingTerminalController extends ScriptableDeviceComponent {

  public const func GetPS() -> ref<VendingTerminalControllerPS> {
    return this.GetBasePS() as VendingTerminalControllerPS;
  }
}
