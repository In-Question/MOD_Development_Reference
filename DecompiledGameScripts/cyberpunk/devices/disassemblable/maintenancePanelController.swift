...
public class MaintenancePanelController extends MasterController {
  ...
  public const func GetPS() -> ref<MaintenancePanelControllerPS> {
    return this.GetBasePS() as MaintenancePanelControllerPS;
  }
}
...
public class MaintenancePanelControllerPS extends MasterControllerPS {
  ...
  protected func GetSkillCheckContainerForSetup() -> ref<BaseSkillCheckContainer> {
    return this.m_maintenancePanelSkillChecks;
  }
