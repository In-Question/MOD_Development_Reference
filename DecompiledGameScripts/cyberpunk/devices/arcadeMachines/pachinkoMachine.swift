...
public class PachinkoMachine extends ArcadeMachine {
  ...
  protected const func GetController() -> ref<PachinkoMachineController> {
    return this.m_controller as PachinkoMachineController;
  }

  public const func GetDevicePS() -> ref<PachinkoMachineControllerPS> {
