...
public class LcdScreen extends InteractiveDevice {
  ...
  protected const func GetController() -> ref<LcdScreenController> {
    return this.m_controller as LcdScreenController;
  }

  public const func GetDevicePS() -> ref<LcdScreenControllerPS> {
  ...
  public final const func GetMessageRecord() -> ref<ScreenMessageData_Record> {
    let id: TweakDBID = this.GetDevicePS().GetMessageRecordID();
    if !TDBID.IsValid(id) {
      return null;
    };
  ...
  public final const func HasCustomNumber() -> Bool {
    return this.GetDevicePS().HasCustomNumber();
  }

  public final const func GetCustomNumber() -> Int32 {
    return this.GetDevicePS().GetCustomNumber();
  }
  ...
  private final func UpdateMessageRecordUI(messageData: ref<ScreenMessageData>) -> Void {
    ...
    if this.GetDevicePS().IsON() {
      this.GetBlackboard().SetVariant(this.GetBlackboardDef().MessegeData, ToVariant(messageData));
      this.GetBlackboard().FireCallbacks();
    };
  }
