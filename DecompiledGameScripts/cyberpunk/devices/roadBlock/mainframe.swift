...
public class Mainframe extends BaseAnimatedDevice {
  ...
  private const func GetController() -> ref<MainframeController> {
    return this.m_controller as MainframeController;
  }

  public const func GetDevicePS() -> ref<MainframeControllerPS> {
