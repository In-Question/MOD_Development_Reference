...
public class RoadBlockTrap extends InteractiveMasterDevice {
  ...
  private const func GetController() -> ref<RoadBlockTrapController> {
    return this.m_controller as RoadBlockTrapController;
  }

  public const func GetDevicePS() -> ref<RoadBlockTrapControllerPS> {
