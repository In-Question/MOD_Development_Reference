...
public class ElevatorFloorTerminal extends Terminal {
  ...
  public const func GetDevicePS() -> ref<ElevatorFloorTerminalControllerPS> {
    return this.GetController().GetPS();
  }

  private const func GetController() -> ref<ElevatorFloorTerminalController> {
    return this.m_controller as ElevatorFloorTerminalController;
  }
  ...
  public func OnMaraudersMapDeviceDebug(sink: ref<MaraudersMapDevicesSink>) -> Void {
    ...
    sink.EndCategory();
    elevatorFloorSetup = this.GetDevicePS().GetElevatorFloorSetup();
    ...
    sink.PushString("Is Elevator at this floor", ToString(this.GetDevicePS().IsElevatorAtThisFloor()));
