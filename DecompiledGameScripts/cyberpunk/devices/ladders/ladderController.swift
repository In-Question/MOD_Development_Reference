...
public class LadderController extends ScriptableDeviceComponent {

  public const func GetPS() -> ref<LadderControllerPS> {
    return this.GetBasePS() as LadderControllerPS;
  }
}
