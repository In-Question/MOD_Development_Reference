...
public class InteractiveSign extends Device {
  ...
  protected const func GetController() -> ref<InteractiveSignController> {
    return this.m_controller as InteractiveSignController;
  }

  public const func GetDevicePS() -> ref<InteractiveSignControllerPS> {
