...
public class BarbedWire extends ActivatedDeviceTrap {
  ...
  protected const func GetController() -> ref<BarbedWireController> {
    return this.m_controller as BarbedWireController;
  }

  public const func GetDevicePS() -> ref<BarbedWireControllerPS> {
...
public class TriggerNotifier_BarbedWire extends TriggerNotifier_Script {
  ...
  @runtimeProperty("customEditor", "TweakDBGroupInheritance;Attacks.Trap_Attack_Base")
