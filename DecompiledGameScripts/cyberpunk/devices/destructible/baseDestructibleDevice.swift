...
public class BaseDestructibleDevice extends Device {
  ...
  protected func ResolveGameplayState() -> Void {
    ...
    if this.GetDevicePS().IsMasterDestroyed() || this.GetDevicePS().IsDestroyed() {
  ...
  private const func GetController() -> ref<BaseDestructibleController> {
    return this.m_controller as BaseDestructibleController;
  }

  public const func GetDevicePS() -> ref<BaseDestructibleControllerPS> {
