...
public class TrafficLightController extends ScriptableDeviceComponent {

  public const func GetPS() -> ref<TrafficLightControllerPS> {
    return this.GetBasePS() as TrafficLightControllerPS;
  }
}
