...
public class TrafficLight extends Device {
  ...
  protected func ResolveGameplayState() -> Void {
    ...
    if this.GetDevicePS().IsMasterDestroyed() {
  ...
  private const func GetController() -> ref<TrafficLightController> {
    return this.m_controller as TrafficLightController;
  }

  public const func GetDevicePS() -> ref<TrafficLightControllerPS> {
