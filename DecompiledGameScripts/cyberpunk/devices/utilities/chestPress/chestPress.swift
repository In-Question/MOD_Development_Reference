...
public class ChestPress extends InteractiveDevice {
  ...
  private const func GetController() -> ref<ChestPressController> {
    return this.m_controller as ChestPressController;
  }

  public const func GetDevicePS() -> ref<ChestPressControllerPS> {
  ...
  protected cb func OnChestPressWeightHack(evt: ref<ChestPressWeightHack>) -> Bool {
    AddFact(this.GetGame(), this.GetDevicePS().GetFactOnQHack());
  }
