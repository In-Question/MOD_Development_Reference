...
public class GameplayLight extends InteractiveDevice {
  ...
  private const func GetController() -> ref<GameplayLightController> {
    return this.m_controller as GameplayLightController;
  }

  public const func GetDevicePS() -> ref<GameplayLightControllerPS> {
