...
public class ElectricLightController extends ScriptableDeviceComponent {

  public const func GetPS() -> ref<ElectricLightControllerPS> {
    return this.GetBasePS() as ElectricLightControllerPS;
  }
}
