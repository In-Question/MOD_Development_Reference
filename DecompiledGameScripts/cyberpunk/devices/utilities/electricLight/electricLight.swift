...
public class ElectricLight extends Device {
  ...
  private const func GetController() -> ref<ElectricLightController> {
    return this.m_controller as ElectricLightController;
  }

  public const func GetDevicePS() -> ref<ElectricLightControllerPS> {
