...
public class AlarmLight extends BasicDistractionDevice {
  ...
  private const func GetController() -> ref<AlarmLightController> {
    return this.m_controller as AlarmLightController;
  }

  public const func GetDevicePS() -> ref<AlarmLightControllerPS> {
