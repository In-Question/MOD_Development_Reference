...
public class AOEEffectorController extends ScriptableDeviceComponent {

  public const func GetPS() -> ref<AOEEffectorControllerPS> {
    return this.GetBasePS() as AOEEffectorControllerPS;
  }
}

public class AOEEffectorControllerPS extends ActivatedDeviceControllerPS {

  protected persistent const let m_effectsToPlay: [CName];
  ...
  public final func GetEffectsToPlay() -> [CName] {
