...
public class GlitchedTurret extends Device {
  ...
  private const func GetController() -> ref<GlitchedTurretController> {
    return this.m_controller as GlitchedTurretController;
  }

  public const func GetDevicePS() -> ref<GlitchedTurretControllerPS> {
