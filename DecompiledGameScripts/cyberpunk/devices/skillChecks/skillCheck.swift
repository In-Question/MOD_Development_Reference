...
public abstract class SkillCheckBase extends IScriptable {
  ...
  protected persistent let m_alternativeName: TweakDBID;

  protected persistent let m_difficulty: EGameplayChallengeLevel;

  protected inline persistent let m_additionalRequirements: ref<GameplayConditionContainer>;

  protected persistent let m_duration: Float;
  ...
  protected persistent let m_skillToCheck: EDeviceChallengeSkill;

  protected persistent let m_baseSkill: ref<GameplaySkillCondition>;
  ...
  public final func SetAlternativeName(name: TweakDBID) -> Void {
    this.m_alternativeName = name;
  }

  public final func SetDifficulty(difficulty: EGameplayChallengeLevel) -> Void {
  ...
  public final const func GetAdditionalRequirements() -> ref<GameplayConditionContainer> {
    return this.m_additionalRequirements;
  }

  public final const func GetSkill() -> EDeviceChallengeSkill {
