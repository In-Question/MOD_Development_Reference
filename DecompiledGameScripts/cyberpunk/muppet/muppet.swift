...
public native class Muppet extends gamePuppetBase {
  ...
  private final func OnHitSounds(hitEvent: ref<gameHitEvent>) -> Void {
    ...
    if IsServer() {
      if GameInstance.GetStatPoolsSystem(this.GetGame()).GetStatPoolValue(Cast<StatsObjectID>(this.GetEntityID()), gamedataStatPoolType.Health) < 30.00 {
        ChatterHelper.PlayCpoServerSyncVoiceOver(this, n"cpo_nearly_dead");
      };
      if GameInstance.GetStatPoolsSystem(this.GetGame()).GetStatPoolValue(Cast<StatsObjectID>(this.GetEntityID()), gamedataStatPoolType.CPO_Armor) == 0.00 {
