...
public abstract class ReactionTransition extends DefaultTransition {
  ...
  protected final func DrawDebugText(scriptInterface: ref<StateGameScriptInterface>, out textLayerId: Uint32, const text: script_ref<String>) -> Void {
    textLayerId = GameInstance.GetDebugVisualizerSystem(scriptInterface.owner.GetGame()).DrawText(new Vector4(500.00, 550.00, 0.00, 0.00), Deref(text), gameDebugViewETextAlignment.Left, new Color(255u, 255u, 0u, 255u));
...
public class Stagger extends ReactionTransition {
  ...
  public final func OnEnter(stateContext: ref<StateContext>, scriptInterface: ref<StateGameScriptInterface>) -> Void {
    ...
    this.SetBlackboardIntVariable(scriptInterface, GetAllBlackboardDefs().PlayerStateMachine.Reaction, 1);
  }
  ...
  public final func OnExit(stateContext: ref<StateContext>, scriptInterface: ref<StateGameScriptInterface>) -> Void {
    ...
    this.SetBlackboardIntVariable(scriptInterface, GetAllBlackboardDefs().PlayerStateMachine.Reaction, 0);
  }
}
