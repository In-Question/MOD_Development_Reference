...
public class BaseCrosshairState extends DefaultTransition {
  ...
  protected final func GetCrosshairStateEnumValue() -> gamePSMCrosshairStates {
    ...
    switch stateName {
      ...
      case n"reloadDriverCombatMountedWeapons":
...
public class DriverCombatMountedWeaponsReloadCrosshairStateDecisions extends BaseCrosshairState {

  protected const func EnterCondition(const stateContext: ref<StateContext>, const scriptInterface: ref<StateGameScriptInterface>) -> Bool {
    let inDriverCombatWithMountedWeapon: Bool = stateContext.IsStateActive(n"Vehicle", n"driverCombatMountedWeapons");
