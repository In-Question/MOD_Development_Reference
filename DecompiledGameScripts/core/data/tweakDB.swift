...
public final class TDB extends TweakDBInterface {
  ...
  public final static func GetIntArray(path: TweakDBID) -> [Int32] {
  ...
  public final static func GetFloatArray(path: TweakDBID) -> [Float] {
  ...
  public final static func GetStringArray(path: TweakDBID) -> [String] {
  ...
  public final static func GetBoolArray(path: TweakDBID) -> [Bool] {
  ...
  public final static func GetCNameArray(path: TweakDBID) -> [CName] {
  ...
  public final static func GetLocKeyArray(path: TweakDBID) -> [CName] {
  ...
  public final static func GetColorArray(path: TweakDBID) -> [Color] {
  ...
  public final static func GetVector2Array(path: TweakDBID) -> [Vector2] {
  ...
  public final static func GetVector3Array(path: TweakDBID) -> [Vector3] {
  ...
  public final static func GetEulerAnglesArray(path: TweakDBID) -> [EulerAngles] {
  ...
  public final static func GetQuaternionArray(path: TweakDBID) -> [Quaternion] {
  ...
  public final static func GetResRefArray(path: TweakDBID) -> [ResRef] {
    return TweakDBInterface.GetResRefArrayDefault(path);
  }

  public final static func GetForeignKey(path: TweakDBID) -> TweakDBID {
    return TweakDBInterface.GetForeignKeyDefault(path);
  }

  public final static func GetForeignKeyArray(path: TweakDBID) -> [TweakDBID] {
    return TweakDBInterface.GetForeignKeyArrayDefault(path);
  }
}
