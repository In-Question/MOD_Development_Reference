...
public class PlayerStateMachineDef extends BlackboardDefinition {
  ...
  public let LatestWeaponReloadTime: BlackboardID_Float;
  ...
  public let MountedToVehicleInDriverSeat: BlackboardID_Bool;

  public let MountedToCombatVehicle: BlackboardID_Bool;

  public let MountedToVehicle: BlackboardID_Bool;

  public let InArmoredVehicle: BlackboardID_Bool;
  ...
  public let FinisherTarget: BlackboardID_EntityID;

  public let IsInteractingWithDevice: BlackboardID_Bool;

  public let IsInteractingViaPersonalLink: BlackboardID_Bool;

  public let IsForceOpeningDoor: BlackboardID_Bool;

  public let IsControllingDevice: BlackboardID_Bool;

  public let IsControllingCamera: BlackboardID_Bool;

  public let IsUIZoomDevice: BlackboardID_Bool;

  public let UIZoomDeviceID: BlackboardID_EntityID;
  ...
  public let TakedownTargetID: BlackboardID_EntityID;
  ...
  public let UploadingQuickHackIDs: BlackboardID_Variant;

  public let CostFreeActionID: BlackboardID_Variant;

  public let AmountOfCostFreeActions: BlackboardID_Int;

  public let MeleeSpreadableQuickhackActionID: BlackboardID_Variant;

  public let EntityIDTargetingPlayer: BlackboardID_EntityID;

  public let EntityIDVehicleRemoteControlled: BlackboardID_EntityID;

  public let IsVehicleRemoteControlCameraTPP: BlackboardID_Bool;
  ...
  public let IsOnGround: BlackboardID_Bool;

  public let MinElevation: BlackboardID_Float;

  public let MaxElevation: BlackboardID_Float;
  ...
  public let LadderCameraParams: BlackboardID_Int;

  public let DodgeTimeStamp: BlackboardID_Float;

  public let CanOnePunch: BlackboardID_Bool;

  public let HasSmartGunLockedOnTarget: BlackboardID_Bool;
  ...
  public let ScenePreventFirstEquip: BlackboardID_Bool;

  public let MountedPreventFirstEquip: BlackboardID_Bool;

  public let IgnoreBarbedWireStateEnterTime: BlackboardID_Float;

  public let IsInLoreAnimationScene: BlackboardID_Bool;

  public let Felled: BlackboardID_Bool;

  public let IsVehicleInTPP: BlackboardID_Bool;

  public let IsDriverCombatInTPP: BlackboardID_Bool;

  public let DriverCombatWeaponType: BlackboardID_Int;

  public let TrackedTarget: BlackboardID_Variant;

  public let TPPAimPosition: BlackboardID_Vector4;

  public let BodySlamBump: BlackboardID_Int;

  public let IsInBodySlamState: BlackboardID_Bool;

  public let AimInTimeRemaining: BlackboardID_Float;

  public let AimInTime: BlackboardID_Float;

  public let CanThrowCarriedNPC: BlackboardID_Bool;

  public let IsWeaponFirstEquip: BlackboardID_Bool;

  public let IsVisualCustomizationPhotomodeVehicleSlotTaken: BlackboardID_Bool;
...
public class PlayerPerkDataDef extends BlackboardDefinition {
  ...
  public let DismembermentInstigated: BlackboardID_Variant;

  public let EntityNoticedPlayer: BlackboardID_Uint;

  public let CombatStateTime: BlackboardID_Float;

  public let LeapedDistance: BlackboardID_Float;

  public let LeapPosition: BlackboardID_Vector4;

  public let LeapTarget: BlackboardID_EntityID;

  public let UsedHealingItemOrCyberware: BlackboardID_Uint;

  public let StartedUsingHealingItemOrCyberware: BlackboardID_Uint;
...
public class PuppetDef extends BlackboardDefinition {
  ...
  public let IsPlayerInterestingFromSecuritySystemPOV: BlackboardID_Bool;
...
public class HackingDataDef extends BlackboardDefinition {
  ...
  public final static func AddItemToSpreadMap(player: wref<PlayerPuppet>, key: wref<InteractionBase_Record>, count: Int32, range: Float) -> Bool {
    ...
    spreadMap = FromVariant<array<SpreadMapItem>>(hackingData.GetVariant(GetAllBlackboardDefs().HackingData.SpreadMap));
    i = 0;
...
public class HackingMinigameDef extends BlackboardDefinition {
  ...
  public let LastPlayerHackPosition: BlackboardID_Vector4;
...
public class UI_PlayerStatsDef extends BlackboardDefinition {
  ...
  public let RequiredXP: BlackboardID_Int;
...
public class PuppetStateDef extends BlackboardDefinition {
  ...
  public let WorkspotAnimationInProgress: BlackboardID_Bool;

  public let InAirAnimation: BlackboardID_Bool;
...
public class ChargedGrenadesBlackBoardDef extends BlackboardDefinition {

  public let curentGrenadeCharges: BlackboardID_Int;

  public let maxGrenadeCharges: BlackboardID_Int;

  public let rechargeGoingOn: BlackboardID_Bool;
...
public class ChargedHealingBlackBoardDef extends BlackboardDefinition {

  public let currHealingItemCharge: BlackboardID_Int;
...
public class BlackwallAnimDef extends BlackboardDefinition {

  public let deathAnimNumber: BlackboardID_Int;

  public let handGestureAnimNumber: BlackboardID_Int;
...
public class EffectSharedDataDef extends BlackboardDefinition {
  ...
  public let height: BlackboardID_Float;

  public let initRange: BlackboardID_Float;

  public let width: BlackboardID_Float;

  public let axisConstraints: BlackboardID_Vector4;
  ...
  public let vfxOffset: BlackboardID_Vector4;

  public let disableVfx: BlackboardID_Bool;

  public let enableImpulseFalloff: BlackboardID_Bool;

  public let impulseFalloffFactor: BlackboardID_Float;
  ...
  public let inTPP: BlackboardID_Bool;

  public let tppScale: BlackboardID_Float;
  ...
  public let randRoll: BlackboardID_Float;

  public let ignoreMountedVehicleCollision: BlackboardID_Bool;
...
public class UIGameDataDef extends BlackboardDefinition {
  ...
  public let BreachUIParams: BlackboardID_Variant;
  ...
  public let ApplyWeaponSwayToCamera: BlackboardID_Bool;

  public let NormalizedWeaponSway: BlackboardID_Vector2;

  public let DriverCombatCrosshairReticle: BlackboardID_Variant;

  public let NotificationJournalHash: BlackboardID_Int;

  public let IsBriefingActive: BlackboardID_Bool;

  public let MuppetStats: BlackboardID_Variant;

  public let ActiveNotificationsQueue: BlackboardID_Int;

  public let BerserkActive: BlackboardID_Bool;

  public let Popup_VehiclesManager_IsShown: BlackboardID_Bool;

  public let Popup_Radio_IsShown: BlackboardID_Bool;

  public let Popup_Radio_Enabled: BlackboardID_Bool;

  public let Popup_CarColorPicker_IsShown: BlackboardID_Bool;

  public let Popup_TwintoneOverride_IsShown: BlackboardID_Bool;

  public let Popup_FrameSwitcher_IsShown: BlackboardID_Bool;
...
public class UIInteractionsDef extends BlackboardDefinition {
  ...
  public let IsQuestNotificationUp: BlackboardID_Bool;
...
public class UI_ActiveVehicleDataDef extends BlackboardDefinition {
  ...
  public let IsFPPRearviewCameraActivated: BlackboardID_Bool;

  public let RemoteControlledVehicleData: BlackboardID_Variant;

  public let MountedWeaponsTargets: BlackboardID_Variant;

  public let MountedMissileLauncherAmmo: BlackboardID_Uint;

  public let MountedPowerWeaponAmmo: BlackboardID_Uint;
...
public class UI_AutodriveDataDef extends BlackboardDefinition {

  public let AutoDriveAvailable: BlackboardID_Bool;

  public let AutoDriveEnabled: BlackboardID_Bool;

  public let AutoDriveDelamain: BlackboardID_Bool;

  public let FreeRoamEnabled: BlackboardID_Bool;

  public let DestinationRemainingLength: BlackboardID_Float;

  public let DestinationRemainingTime: BlackboardID_Float;

  public let CinematicCameraActive: BlackboardID_Bool;
...
public class VehicleDef extends BlackboardDefinition {
  ...
  public let HeadLightMode: BlackboardID_Int;
  ...
  public let ChaseIsChaseDontAvoidPedestrians: BlackboardID_Bool;

  public let ChaseMaxRammingTickets: BlackboardID_Uint;

  public let ChaseTimeDelayToLeaveVehicle: BlackboardID_Float;

  public let MinimapMappinDeleteAnim: BlackboardID_Name;

  public let UseCarAlarmStim: BlackboardID_Bool;

  public let VehicleCustomizationBlockedByDamage: BlackboardID_Bool;

  public let VehicleCustomizationActive: BlackboardID_Bool;

  public let VehicleCustomizationDecoPreset: BlackboardID_Int;

  public let VehicleCustomizationInstant: BlackboardID_Bool;

  public let VehicleCustomizationWidgetDelay: BlackboardID_Float;

  public let VehicleCustomizationPhotoMode: BlackboardID_Bool;
...
public class VehiclePurchaseDataDef extends BlackboardDefinition {

  public let PurchasedVehicleRecordID: BlackboardID_Variant;
...
public class FastTRavelSystemDef extends BlackboardDefinition {
  ...
  public let FastTravelStarted: BlackboardID_Bool;

  public let FastTravelLoadingScreenStarted: BlackboardID_Bool;

  public let FastTravelLoadingScreenFinished: BlackboardID_Bool;

  public let LastSubwayGateUsed: BlackboardID_EntityID;
...
public class NetworkBlackboardDef extends BlackboardDefinition {
  ...
  public let PersonalLinkStatus: BlackboardID_Int;
...
public class SniperNestDeviceBlackboardDef extends BlackboardDefinition {

  public let IsInTheSniperNest: BlackboardID_Bool;

  public let FastForwardToZoom4: BlackboardID_Bool;

  public let SniperNestDefaultSpeedMultiplier: BlackboardID_Float;

  public let SniperNestZoomedSpeedMultiplier: BlackboardID_Float;
...
public class TokenUpgradedCyberwareBlackboardDef extends BlackboardDefinition {

  public let CyberwareTypes: BlackboardID_Variant;
...
public class UI_ComDeviceDef extends BlackboardDefinition {
  ...
  public let SmsMessengerActive: BlackboardID_Bool;

  public let MessageToOpenId: BlackboardID_Name;

  public let PhoneEnabled: BlackboardID_Bool;

  public let PhoneVisibility: BlackboardID_Variant;

  public let ActivatePhoneElements: BlackboardID_Uint;

  public let MessageToOpenHash: BlackboardID_Int;
...
public class UI_ScannerDef extends BlackboardDefinition {
  ...
  public let scannerChangeTargetTooltipVisibility: BlackboardID_Bool;
  ...
  public let scannerActiveTab: BlackboardID_Variant;

  public let twintoneAvailable: BlackboardID_Bool;

  public let twintoneApplyAvailable: BlackboardID_Bool;

  public let twintoneNoModelAvailable: BlackboardID_Bool;
...
public class UI_ScannerModulesDef extends BlackboardDefinition {
  ...
  public let ScannerVehicleCustomization: BlackboardID_Variant;
...
public class UI_WantedBarDef extends BlackboardDefinition {
  ...
  public let DeescalationStages: BlackboardID_Int;

  public let CurrentChaseState: BlackboardID_Name;

  public let BlinkingStarsDurationTime: BlackboardID_Float;

  public let IsDogtown: BlackboardID_Bool;
...
public class UI_HUDProgressBarDef extends BlackboardDefinition {
  ...
  public let BottomText: BlackboardID_String;

  public let CompletedText: BlackboardID_String;

  public let FailedText: BlackboardID_String;

  public let Active: BlackboardID_Bool;

  public let Progress: BlackboardID_Float;

  public let ProgressBump: BlackboardID_Float;

  public let MessageType: BlackboardID_Variant;
...
public class UI_HUDSignalProgressBarDef extends BlackboardDefinition {
  ...
  public let Orientation: BlackboardID_Uint;

  public let Appearance: BlackboardID_Name;
...
public class UI_HUDCountdownTimerDef extends BlackboardDefinition {
...
public class UI_InterfaceOptionsDef extends BlackboardDefinition {
  ...
  public let NPCNameplatesEnabled: BlackboardID_Bool;

  public let HUDMarkersEnabled: BlackboardID_Bool;
...
public class UI_TargetingInfoDef extends BlackboardDefinition {
  ...
  public let CrosshairRaycastTarget: BlackboardID_EntityID;
...
public class UI_QuickSlotsDataDef extends BlackboardDefinition {
  ...
  public let quickhackPanelBlocked: BlackboardID_Bool;

  public let quickHackDataSelected: BlackboardID_Variant;

  public let quickhackPanelKeepContext: BlackboardID_Bool;
...
public class UI_MapDef extends BlackboardDefinition {
  ...
  public let minimapLayerHighlightRequest: BlackboardID_Variant;
...
public class AIShootingDataDef extends AIBlackboardDef {
  ...
  public let pauseConditionCheckTimeStamp: BlackboardID_Float;

  public let lastChargeLevel: BlackboardID_Float;
  ...
  public let shootingFromCar: BlackboardID_Bool;
...
public class UI_AttributeBoughtDef extends BlackboardDefinition {

  public let attribute: BlackboardID_Variant;
...
public class AIActionDataDef extends AIBlackboardDef {
  ...
  public let ownerInTumble: BlackboardID_Bool;

  public let ownerCurrentAnimVariationSet: BlackboardID_Bool;

  public let ownerLastAnimVariationAction: BlackboardID_Variant;

  public let ownerLastAnimVariation: BlackboardID_Int;

  public let ownerLastBlockAnimVariation: BlackboardID_Int;
  ...
  public let ownerGlobalTimeDilation: BlackboardID_Float;
  ...
  public let ignoreInCombatMoveCommand: BlackboardID_Bool;

  public let avoidLOSTimeStamp: BlackboardID_Float;

  public let attackBlocked: BlackboardID_Bool;

  public let attackParried: BlackboardID_Bool;

  public let lastGrenadeThrowTimestamp: BlackboardID_Float;
  ...
  public final const func Initialize(blackboard: ref<IBlackboard>) -> Void {
    ...
    blackboard.SetFloat(this.ownerGlobalTimeDilation, -1.00);
    blackboard.SetFloat(this.lastGrenadeThrowTimestamp, -1.00);
  }
}

public class AIPrereqsDataDef extends AIBlackboardDef {

  public let npcHitTypeTimeout: BlackboardID_Variant;
...
public class AIActionBossDataDef extends AIBlackboardDef {
  ...
  public let excludedTeleportPosition: BlackboardID_Vector4;
...
public class UI_ItemModSystemDef extends BlackboardDefinition {
  ...
  public let ItemModSystemUpgradingInProgress: BlackboardID_Bool;
...
public class AdHocAnimationDef extends BlackboardDefinition {
  ...
  public let AnimationDuration: BlackboardID_Float;
...
public class UI_EquipmentDef extends BlackboardDefinition {
  ...
  public let areaChanged: BlackboardID_Int;

  public let areaChangedSlotIndex: BlackboardID_Int;

  public let EquipmentInProgress: BlackboardID_Bool;
...
public class UI_InventoryDef extends BlackboardDefinition {

  public let itemAdded: BlackboardID_Variant;

  public let itemRemoved: BlackboardID_Variant;

  public let itemQuantityChanged: BlackboardID_Variant;
...
public class UI_StealthDef extends BlackboardDefinition {
  ...
  public let highestDetectionOnPlayer: BlackboardID_Float;

  public let highestHostileDetectionOnPlayer: BlackboardID_Float;
...
public class InputSchemesDef extends BlackboardDefinition {

  public let Device: BlackboardID_Uint;

  public let Scheme: BlackboardID_Uint;

  public let InitializedInputHintManagerList: BlackboardID_Variant;
...
public class PoliceChaseParamsDef extends BlackboardDefinition {

  public let SearchAreaRadius: BlackboardID_Float;

  public let ChasePlayerDistance: BlackboardID_Float;
