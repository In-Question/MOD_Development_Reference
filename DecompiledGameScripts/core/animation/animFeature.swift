...
public class AnimFeature_PerkDeviceData extends AnimFeature {

  public edit let isUsed: Bool;

  public final static func GetFeatureName() -> CName {
    return n"PerkDeviceData";
  }
}
