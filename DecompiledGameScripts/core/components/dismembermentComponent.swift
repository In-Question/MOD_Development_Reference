...
public native class DismembermentComponent extends IComponent {
  ...
  public final static func RequestGutsFromLastHit(obj: ref<GameObject>, const resourcePath: script_ref<String>, strength: Float) -> Void {
    let evt: ref<DismembermentDebrisEvent> = new DismembermentDebrisEvent();
    evt.m_resourcePath = Deref(resourcePath);
