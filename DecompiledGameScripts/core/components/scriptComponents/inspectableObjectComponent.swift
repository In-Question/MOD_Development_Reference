...
public class InspectableObjectComponentPS extends GameComponentPS {
  ...
  private let m_listeners: [ref<ObjectInspectListener>];
...
public class InspectableObjectComponent extends ScriptableComponent {
  ...
  protected const func GetPS() -> ref<InspectableObjectComponentPS> {
    return this.GetBasePS() as InspectableObjectComponentPS;
  }
