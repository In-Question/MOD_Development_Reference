...
public class AdamSmasherHealthChangeListener extends CustomValueStatPoolsListener {
  ...
  public final func CheckPhase(oldValue: Float, newValue: Float, percToPoints: Float) -> Void {
    if oldValue > 80.00 && newValue <= 80.00 && StatusEffectSystem.ObjectHasStatusEffect(this.m_owner, t"AdamSmasher.Phase1") && !StatusEffectSystem.ObjectHasStatusEffect(this.m_owner, t"AdamSmasher.DestroyedPlate") {
      ...
      this.DisableAllSandyEdgerunnerFxs();
    };
    if oldValue > 50.00 && newValue <= 50.00 && StatusEffectSystem.ObjectHasStatusEffect(this.m_owner, t"AdamSmasher.Phase1") {
      this.ApplyPhase2();
    ...
    if oldValue > 30.00 && newValue <= 30.00 && !StatusEffectSystem.ObjectHasStatusEffect(this.m_owner, t"AdamSmasher.Invulnerable") {
      this.ApplyEmergency();
      this.DisableAllSandyEdgerunnerFxs();
    };
  ...
  private final func DisableAllSandyEdgerunnerFxs() -> Void {
    GameObject.BreakReplicatedEffectLoopEvent(this.m_owner, n"sandevistan_high_00");
    GameObject.BreakReplicatedEffectLoopEvent(this.m_owner, n"sandevistan_high_01");
    GameObject.BreakReplicatedEffectLoopEvent(this.m_owner, n"sandevistan_high_02");
    GameObject.BreakReplicatedEffectLoopEvent(this.m_owner, n"sandevistan_high_03");
    GameObject.BreakReplicatedEffectLoopEvent(this.m_owner, n"sandevistan_low_00");
    GameObject.BreakReplicatedEffectLoopEvent(this.m_owner, n"sandevistan_low_01");
    GameObject.BreakReplicatedEffectLoopEvent(this.m_owner, n"sandevistan_low_02");
    GameObject.BreakReplicatedEffectLoopEvent(this.m_owner, n"sandevistan_low_03");
    GameObject.BreakReplicatedEffectLoopEvent(this.m_owner, n"sandevistan_medium_00");
    GameObject.BreakReplicatedEffectLoopEvent(this.m_owner, n"sandevistan_medium_01");
    GameObject.BreakReplicatedEffectLoopEvent(this.m_owner, n"sandevistan_medium_02");
    GameObject.BreakReplicatedEffectLoopEvent(this.m_owner, n"sandevistan_medium_03");
  }
...
public class AdamSmasherComponent extends ScriptableComponent {
  ...
  public final func OnGameAttach() -> Void {
    ...
    this.EnableRipInteractionLayer();
  ...
  public final static func GetDefeatedHealthValue() -> Float {
    return 0.00;
  }
  ...
  protected cb func OnDefeated(evt: ref<DefeatedEvent>) -> Bool {
    ...
    GameObject.StartReplicatedEffectEvent(this.m_owner, n"grenade_explode_takedown");
  }
  ...
  protected cb func OnStatusEffectApplied(evt: ref<ApplyStatusEffectEvent>) -> Bool {
    ...
    if ArrayContains(tags, n"Overload") {
      if Equals(this.m_weakspotDestroyed, false) && StatusEffectSystem.ObjectHasStatusEffect(this.m_owner, t"AdamSmasher.Phase1") && StatusEffectSystem.ObjectHasStatusEffect(this.m_owner, t"AdamSmasher.Destroyed_Plate") && StatusEffectSystem.ObjectHasStatusEffectOfType(this.m_owner, gamedataStatusEffectType.QuickHackStaggerCyberware) {
        StatusEffectHelper.GetAppliedEffectsWithTag(this.m_owner, n"CyberwareMalfunction", statusEffects);
        if ArraySize(statusEffects) > 0 && statusEffects[0].GetStackCount() >= 4u {
          this.m_weakspotDestroyed = true;
          StatusEffectHelper.RemoveAllStatusEffectsByType(this.m_owner.GetGame(), this.m_owner_id, gamedataStatusEffectType.QuickHackStaggerCyberware);
          this.ApplyNoInterrupt();
          this.SetPercentLifeForPhase(50.00);
          StatusEffectHelper.ApplyStatusEffect(this.m_owner, t"AdamSmasher.InvulnerableDefeated", this.m_owner_id);
        };
      };
    };
    if ArrayContains(tags, n"ChimeraSuicide") || ArrayContains(tags, n"ChimeraBlackWall") {
      if StatusEffectSystem.ObjectHasStatusEffect(this.m_owner, t"AdamSmasher.Phase1") {
        ...
        if StatusEffectSystem.ObjectHasStatusEffect(this.m_owner, t"AdamSmasher.Phase2") {
          if this.m_statPoolSystem.GetStatPoolValue(Cast<StatsObjectID>(this.m_owner.GetEntityID()), gamedataStatPoolType.Health, true) > 30.00 {
            this.SetPercentLifeForPhase(30.00);
          } else {
            this.SetPercentLifeForPhase(5.00);
          };
        } else {
          if StatusEffectSystem.ObjectHasStatusEffect(this.m_owner, t"AdamSmasher.Phase3") {
    ...
    if ArrayContains(tags, n"SmasherCustomHackTakedown") {
      ...
      if ArrayContains(tags, n"SmasherCustomHack") {
        if this.m_statPoolSystem.GetStatPoolValue(Cast<StatsObjectID>(this.m_owner.GetEntityID()), gamedataStatPoolType.Health, true) > 50.00 {
          this.ApplyNoInterrupt();
          this.SetPercentLifeForPhase(50.00);
        } else {
          if this.m_statPoolSystem.GetStatPoolValue(Cast<StatsObjectID>(this.m_owner.GetEntityID()), gamedataStatPoolType.Health, true) <= 50.00 && this.m_statPoolSystem.GetStatPoolValue(Cast<StatsObjectID>(this.m_owner.GetEntityID()), gamedataStatPoolType.Health, true) > 30.00 {
            this.SetPercentLifeForPhase(30.00);
          } else {
            if this.m_statPoolSystem.GetStatPoolValue(Cast<StatsObjectID>(this.m_owner.GetEntityID()), gamedataStatPoolType.Health, true) > 5.00 {
              this.SetPercentLifeForPhase(5.00);
            } else {
              if this.m_statPoolSystem.GetStatPoolValue(Cast<StatsObjectID>(this.m_owner.GetEntityID()), gamedataStatPoolType.Health, true) <= 30.00 && !StatusEffectSystem.ObjectHasStatusEffect(this.m_owner, t"AdamSmasher.Invulnerable") {
    ...
    if ArrayContains(tags, n"SmasherCustomStatusEffect") {
      if StatusEffectSystem.ObjectHasStatusEffect(this.m_owner, t"AdamSmasher.Destroyed_Plate") && StatusEffectSystem.ObjectHasStatusEffect(this.m_owner, t"AdamSmasher.Phase1") {
        this.SetHealth(this.m_owner, 80.00);
      };
    };
  ...
  private final func SetHealth(target: ref<NPCPuppet>, valueToSet: Float) -> Void {
    ...
    currentHealth = GameInstance.GetStatPoolsSystem(target.GetGame()).GetStatPoolValue(Cast<StatsObjectID>(target.GetEntityID()), gamedataStatPoolType.Health, true);
    finalValue = valueToSet - currentHealth;
    GameInstance.GetStatPoolsSystem(target.GetGame()).RequestChangingStatPoolValue(Cast<StatsObjectID>(target.GetEntityID()), gamedataStatPoolType.Health, finalValue, null, true);
  }
