...
public class ScannerControlComponent extends ScriptableComponent {
  ...
  protected final func OnGameAttach() -> Void {
    this.m_currentScanType = MechanicalScanType.None;
  ...
  protected final func StartFullscreenPlayerVFX() -> Void {
    ...
    if Equals(this.m_currentScanType, MechanicalScanType.None) || Equals(this.m_currentScanType, MechanicalScanType.Short) {
      return;
    };
  ...
  private final func StartScanning(scanType: MechanicalScanType) -> Void {
    if Equals(this.m_currentScanType, MechanicalScanType.None) {
