...
public class HitShapeUserDataBase extends HitShapeUserData {
  ...
  public edit let m_quickHacksPierceProtection: Bool;
  ...
  public final static func DoQuickHacksPierceProtection(userData: ref<HitShapeUserDataBase>) -> Bool {
  ...
  public final static func GetDismembermentBodyPart(userData: ref<HitShapeUserDataBase>) -> gameDismBodyPart {
    let str: String = EnumValueToString("EAIDismembermentBodyPart", Cast<Int64>(EnumInt(userData.m_dismembermentPart)));
    let dismBodyPart: gameDismBodyPart = IntEnum<gameDismBodyPart>(Cast<Int32>(EnumValueFromString("gameDismBodyPart", str)));
    return dismBodyPart;
  }
  ...
  public final static func IsHitReactionZoneRightArm(userData: ref<HitShapeUserDataBase>) -> Bool {
    return Equals(userData.m_hitReactionZone, EHitReactionZone.ArmRight) || Equals(userData.m_hitReactionZone, EHitReactionZone.HandRight);
  }

  public final static func IsHitReactionZoneArm(userData: ref<HitShapeUserDataBase>) -> Bool {
    return Equals(userData.m_hitReactionZone, EHitReactionZone.ArmRight) || Equals(userData.m_hitReactionZone, EHitReactionZone.HandRight) || Equals(userData.m_hitReactionZone, EHitReactionZone.ArmLeft) || Equals(userData.m_hitReactionZone, EHitReactionZone.HandLeft);
  }
