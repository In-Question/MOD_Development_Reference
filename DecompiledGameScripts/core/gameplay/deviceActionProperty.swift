...
public class DeviceActionPropertyFunctions extends IScriptable {
  ...
  public final static func GetProperty_Bool(prop: ref<DeviceActionProperty>, out value: Bool, out nameOnFalse: CName, out nameOnTrue: CName) -> Bool {
    ...
    value = FromVariant<Bool>(prop.first);
    nameOnTrue = FromVariant<CName>(prop.second);
    nameOnFalse = FromVariant<CName>(prop.third);
    return true;
  }
  ...
  public final static func GetProperty_Float(prop: ref<DeviceActionProperty>, out value: Float) -> Bool {
    ...
    value = FromVariant<Float>(prop.first);
    return true;
  }
  ...
  public final static func GetProperty_Int(prop: ref<DeviceActionProperty>, out value: Int32) -> Bool {
    ...
    value = FromVariant<Int32>(prop.first);
    return true;
  }
  ...
  public final static func GetProperty_IntRanged(prop: ref<DeviceActionProperty>, out value: Int32, out rangeMin: Int32, out rangeMax: Int32) -> Bool {
    ...
    value = FromVariant<Int32>(prop.first);
    rangeMin = FromVariant<Int32>(prop.second);
    rangeMax = FromVariant<Int32>(prop.third);
    return true;
  }
  ...
  public final static func GetProperty_Name(prop: ref<DeviceActionProperty>, out value: CName) -> Bool {
    ...
    value = FromVariant<CName>(prop.first);
    return true;
  }

  public final static func SetUpProperty_RadioStatus(propertyName: CName, deviceStatus: Int32, const stationName: script_ref<String>) -> ref<DeviceActionProperty> {
    let prop: ref<DeviceActionProperty> = new DeviceActionProperty();
    prop.name = propertyName;
  ...
  public final static func GetProperty_RadioStatus(prop: ref<DeviceActionProperty>, out deviceStatus: Int32, stationName: script_ref<String>) -> Bool {
    if NotEquals(prop.typeName, n"RadioStatus") {
      return false;
    };
    deviceStatus = FromVariant<Int32>(prop.first);
    stationName = FromVariant<String>(prop.second);
    return true;
  }

  public final static func SetUpProperty_TvStatus(propertyName: CName, deviceStatus: Int32, const stationName: script_ref<String>) -> ref<DeviceActionProperty> {
    let prop: ref<DeviceActionProperty> = new DeviceActionProperty();
    prop.name = propertyName;
  ...
  public final static func GetProperty_TvStatus(prop: ref<DeviceActionProperty>, out deviceStatus: Int32, stationName: script_ref<String>) -> Bool {
  ...
  public final static func SetUpProperty_MediaStatus(propertyName: CName, deviceStatus: Int32, const stationName: script_ref<String>) -> ref<DeviceActionProperty> {
    let prop: ref<DeviceActionProperty> = new DeviceActionProperty();
    prop.name = propertyName;
  ...
  public final static func GetProperty_MediaStatus(prop: ref<DeviceActionProperty>, out deviceStatus: Int32, stationName: script_ref<String>) -> Bool {
  ...
  public final static func GetProperty_NodeRef(prop: ref<DeviceActionProperty>, out value: NodeRef) -> Bool {
    ...
    value = FromVariant<NodeRef>(prop.first);
    return true;
  }
  ...
  public final static func GetProperty_EntityReference(prop: ref<DeviceActionProperty>, out value: EntityReference) -> Bool {
    ...
    value = FromVariant<EntityReference>(prop.first);
    return true;
  }
}
