...
public class PlayVFXEffector extends Effector {
  ...
  protected func Initialize(record: TweakDBID, game: GameInstance, parentRecord: TweakDBID) -> Void {
    this.m_vfxName = TweakDBInterface.GetCName(record + t".vfxName", n"None");
...
public class PlaySFXEffector extends Effector {
  ...
  protected func Initialize(record: TweakDBID, game: GameInstance, parentRecord: TweakDBID) -> Void {
    this.activationSFXName = TweakDBInterface.GetCName(record + t".activationSFXName", n"None");
    this.deactivationSFXName = TweakDBInterface.GetCName(record + t".deactivationSFXName", n"None");
    this.m_startOnUninitialize = TweakDBInterface.GetBool(record + t".startOnUninitialize", false);
