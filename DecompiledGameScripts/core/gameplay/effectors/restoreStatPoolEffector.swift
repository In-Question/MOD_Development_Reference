...
public class RestoreStatPoolEffector extends Effector {
  ...
  protected func ActionOn(owner: ref<GameObject>) -> Void {
    if NotEquals(this.m_statPoolType, gamedataStatPoolType.Invalid) && this.m_valueToRestore > 0.00 {
      GameInstance.GetStatPoolsSystem(owner.GetGame()).RequestChangingStatPoolValue(Cast<StatsObjectID>(owner.GetEntityID()), this.m_statPoolType, this.m_valueToRestore, owner, false, this.m_percentage);
    };
  }
}
