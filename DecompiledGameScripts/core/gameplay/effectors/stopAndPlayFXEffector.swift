...
public class StopAndPlayVFXEffector extends Effector {
  ...
  protected func Initialize(record: TweakDBID, game: GameInstance, parentRecord: TweakDBID) -> Void {
    this.m_vfxToStop = TweakDBInterface.GetCName(record + t".vfxToStop", n"None");
    this.m_vfxToStart = TweakDBInterface.GetCName(record + t".vfxToStart", n"None");
  }
...
public class StopAndPlaySFXEffector extends Effector {
  ...
  protected func Initialize(record: TweakDBID, game: GameInstance, parentRecord: TweakDBID) -> Void {
    this.m_sfxToStop = TweakDBInterface.GetCName(record + t".sfxToStop", n"None");
    this.m_sfxToStart = TweakDBInterface.GetCName(record + t".sfxToStart", n"None");
  }
