...
public class DismemberEffector extends Effector {
  ...
  protected func ActionOn(owner: ref<GameObject>) -> Void {
    DismembermentComponent.RequestDismemberment(owner, IntEnum<gameDismBodyPart>(Cast<Int32>(EnumValueFromName(n"gameDismBodyPart", this.m_bodyPart))), IntEnum<gameDismWoundType>(Cast<Int32>(EnumValueFromName(n"gameDismWoundType", this.m_woundType))), Vector4.Vector3To4(this.m_hitPosition), this.m_isCritical);
  }
}
