...
public class AddDevelopmentPointEffector extends Effector {
  ...
  protected func Initialize(record: TweakDBID, game: GameInstance, parentRecord: TweakDBID) -> Void {
    ...
    this.m_type = IntEnum<gamedataDevelopmentPointType>(Cast<Int32>(EnumValueFromString("gamedataDevelopmentPointType", str)));
  }
...
public class BuyAttributeEffector extends Effector {
  ...
  protected func Initialize(record: TweakDBID, game: GameInstance, parentRecord: TweakDBID) -> Void {
    ...
    this.m_type = IntEnum<gamedataStatType>(Cast<Int32>(EnumValueFromString("gamedataStatType", str)));
  }
