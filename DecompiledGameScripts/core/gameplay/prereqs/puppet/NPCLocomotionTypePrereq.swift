...
public class NPCLocomotionTypePrereq extends IScriptablePrereq {
  ...
  protected func Initialize(recordID: TweakDBID) -> Void {
    ...
    ArrayPush(this.m_locomotionMode, IntEnum<gamedataLocomotionMode>(Cast<Int32>(EnumValueFromString("gamedataLocomotionMode", str))));
  ...
  public final const func Evaluate(owner: ref<GameObject>, value: Int32) -> Bool {
    if ArrayContains(this.m_locomotionMode, IntEnum<gamedataLocomotionMode>(value)) {
