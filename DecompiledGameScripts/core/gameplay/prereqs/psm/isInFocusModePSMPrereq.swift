...
public class IsInFocusModePSMPrereq extends PlayerStateMachinePrereq {
  ...
  protected const func OnRegister(state: ref<PrereqState>, game: GameInstance, context: ref<IScriptable>) -> Bool {
    ...
    let castedState: ref<IsInFocusModePSMPrereqState> = state as IsInFocusModePSMPrereqState;
    ...
    castedState.m_listenerInt = bb.RegisterListenerInt(GetAllBlackboardDefs().PlayerStateMachine.Vision, castedState, n"OnStateUpdate");
    return false;
  }
