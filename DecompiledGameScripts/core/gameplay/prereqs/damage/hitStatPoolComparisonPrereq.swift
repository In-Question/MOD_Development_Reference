...
public class HitStatPoolComparisonPrereqState extends GenericHitPrereqState {
  ...
  private final func ComparePoolValues(hitEvent: ref<gameHitEvent>, const prereq: ref<HitStatPoolComparisonPrereq>) -> Bool {
    ...
    sourcePoolValue = sps.GetStatPoolValue(Cast<StatsObjectID>(source.GetEntityID()), prereq.m_statPoolToCompare);
    targetPoolValue = sps.GetStatPoolValue(Cast<StatsObjectID>(target.GetEntityID()), prereq.m_statPoolToCompare);
