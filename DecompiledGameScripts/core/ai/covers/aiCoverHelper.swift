...
public class AICoverHelper extends IScriptable {
  ...
  public final static func GetCurrentCoverStance(puppet: ref<ScriptedPuppet>, out coverStance: gameCoverHeight) -> Void {
    let coverStanceName: CName = puppet.GetAIControllerComponent().GetCoverBlackboard().GetName(GetAllBlackboardDefs().AICover.currentCoverStance);
  ...
  public final static func SetCurrentCoverStance(puppet: ref<ScriptedPuppet>, value: gameCoverHeight) -> Void {
    puppet.GetAIControllerComponent().GetCoverBlackboard().SetName(GetAllBlackboardDefs().AICover.currentCoverStance, EnumValueToName(n"gameCoverHeight", Cast<Int64>(EnumInt(value))));
  }
  ...
  public final static func GetDesiredCoverStance(puppet: ref<ScriptedPuppet>, out coverStance: gameCoverHeight) -> Void {
    let coverStanceName: CName = puppet.GetAIControllerComponent().GetCoverBlackboard().GetName(GetAllBlackboardDefs().AICover.desiredCoverStance);
    coverStance = AICoverHelper.CoverHeightNameToEnum(coverStanceName);
  }
  ...
  public final static func SetDesiredCoverStance(puppet: ref<ScriptedPuppet>, value: gameCoverHeight) -> Void {
    return puppet.GetAIControllerComponent().GetCoverBlackboard().SetName(GetAllBlackboardDefs().AICover.desiredCoverStance, EnumValueToName(n"gameCoverHeight", Cast<Int64>(EnumInt(value))));
  }
  ...
  public final static func GetFallbackCoverExposureMethod(puppet: ref<ScriptedPuppet>, out method: AICoverExposureMethod) -> Void {
    let methodName: CName = puppet.GetAIControllerComponent().GetCoverBlackboard().GetName(GetAllBlackboardDefs().AICover.fallbackExposureMethod);
    method = IntEnum<AICoverExposureMethod>(Cast<Int32>(EnumValueFromName(n"AICoverExposureMethod", methodName)));
  }

  public final static func GetCoverExposureMethod(puppet: ref<ScriptedPuppet>, out method: AICoverExposureMethod) -> Void {
    let methodName: CName = puppet.GetAIControllerComponent().GetCoverBlackboard().GetName(GetAllBlackboardDefs().AICover.exposureMethod);
    method = IntEnum<AICoverExposureMethod>(Cast<Int32>(EnumValueFromName(n"AICoverExposureMethod", methodName)));
  }

  public final static func HasAnyCoverLastAvailableExposureMethod(puppet: ref<ScriptedPuppet>) -> Bool {
    return puppet.GetAIControllerComponent().GetCoverBlackboard().GetUint(GetAllBlackboardDefs().AICover.lastAvailableMethods) != 0u;
  }
  ...
  public final static func GetRandomCoverLastAvailableExposureMethod(puppet: ref<ScriptedPuppet>, out method: AICoverExposureMethod) -> Void {
    ...
    let tmp: Uint32;
    let lastAvailableMethods: Uint32 = puppet.GetAIControllerComponent().GetCoverBlackboard().GetUint(GetAllBlackboardDefs().AICover.lastAvailableMethods);
    method = AICoverExposureMethod.Count;
    if lastAvailableMethods != 0u {
      randomOffset = Cast<Uint32>(RandRange(0, 15));
      i = 0;
      while i < 15 {
        tmp = (Cast<Uint32>(i) + randomOffset) % 15u;
        if Cast<Bool>(lastAvailableMethods & Cast<Uint32>(PowF(2.00, Cast<Float>(tmp)))) {
          method = IntEnum<AICoverExposureMethod>(tmp);
        };
        i += 1;
      };
    };
  ...
  public final static func SetCoverExposureMethod(puppet: ref<ScriptedPuppet>, value: AICoverExposureMethod) -> Void {
    return puppet.GetAIControllerComponent().GetCoverBlackboard().SetName(GetAllBlackboardDefs().AICover.exposureMethod, EnumValueToName(n"AICoverExposureMethod", Cast<Int64>(EnumInt(value))));
  }

  public final static func SetFallbackCoverExposureMethod(puppet: ref<ScriptedPuppet>, value: AICoverExposureMethod) -> Void {
    return puppet.GetAIControllerComponent().GetCoverBlackboard().SetName(GetAllBlackboardDefs().AICover.fallbackExposureMethod, EnumValueToName(n"AICoverExposureMethod", Cast<Int64>(EnumInt(value))));
  }

  public final static func SetCoverLastAvailableExposureMethod(puppet: ref<ScriptedPuppet>, opt exposureMethods: [AICoverExposureMethod]) -> Void {
    let methodsMask: Uint32 = 0u;
    let i: Int32 = 0;
    while i < ArraySize(exposureMethods) {
      methodsMask = methodsMask | Cast<Uint32>(PowF(2.00, Cast<Float>(EnumInt(exposureMethods[i]))));
      i += 1;
    };
    methodsMask = methodsMask & ~Cast<Uint32>(PowF(2.00, 0.00));
    methodsMask = methodsMask & ~Cast<Uint32>(PowF(2.00, 1.00));
    methodsMask = methodsMask & ~Cast<Uint32>(PowF(2.00, 4.00));
    methodsMask = methodsMask & ~Cast<Uint32>(PowF(2.00, 5.00));
  ...
  public final static func FillEmptyCoverExposureMethodArray() -> [AICoverExposureMethod] {
  ...
  public final static func FillEmptyCoverExposureMethodNameArray() -> [CName] {
  ...
  public final static func HasCoverExposureMethods(const puppetOwner: wref<ScriptedPuppet>, const coverID: Uint64, const target: wref<GameObject>, const exposureMethods: script_ref<[AICoverExposureMethod]>) -> Bool {
    let i: Int32;
    let j: Int32;
    let usableExposureSpots: array<gameAvailableExposureMethodResult>;
    if ArraySize(Deref(exposureMethods)) == 0 {
      return true;
    };
    ...
    while i < ArraySize(usableExposureSpots) {
      j = 0;
      while j < ArraySize(Deref(exposureMethods)) {
        if usableExposureSpots[i].distanceToTarget == 0.00 && Equals(usableExposureSpots[i].method, Deref(exposureMethods)[j]) {
          break;
        };
        j += 1;
      };
      if j >= ArraySize(Deref(exposureMethods)) {
        return false;
      };
      i += 1;
    };
  ...
  public final static func HasCoverExposureMethods(const ownerPuppet: wref<ScriptedPuppet>, const coverID: Uint64, const target: wref<GameObject>, const exposureMethods: script_ref<[CName]>) -> Bool {
    let methods: array<AICoverExposureMethod>;
    let i: Int32 = 0;
    while i < ArraySize(Deref(exposureMethods)) {
      ArrayPush(methods, AICoverHelper.CoverExposureMethodNameToEnum(Deref(exposureMethods)[i]));
      i += 1;
    };
    return AICoverHelper.HasCoverExposureMethods(ownerPuppet, coverID, target, methods);
  }

  public final static func GetAvailableExposureSpots(puppet: wref<ScriptedPuppet>, coverID: Uint64, const target: wref<GameObject>, requestedExposureMethods: [AICoverExposureMethod], lineOfSightTolerance: Float, opt exposureMethodPriority: [wref<AIExposureMethodType_Record>]) -> [AICoverExposureMethod] {
  ...
  public final static func GetAvailableExposureSpots(puppet: wref<ScriptedPuppet>, coverID: Uint64, const target: wref<GameObject>, record: wref<AISubActionCover_Record>, lineOfSightTolerance: Float, opt exposureMethodPriority: [wref<AIExposureMethodType_Record>]) -> [AICoverExposureMethod] {
  ...
  public final static func GetAvailableExposureSpots(puppet: wref<ScriptedPuppet>, coverID: Uint64, const target: wref<GameObject>, record: wref<AISubActionCover_Record>, lineOfSightTolerance: Float, opt exposureMethodPriority: [wref<AIExposureMethodType_Record>], allAvailableExposureMethods: script_ref<[AICoverExposureMethod]>) -> [AICoverExposureMethod] {
    ...
    let cm: ref<CoverManager> = AICoverHelper.GetCoverManager(puppet);
    if !IsDefined(cm) {
      return Deref(allAvailableExposureMethods);
    };
    ...
    if IsDefined(tmpVariant) {
      coverCommandParams = FromVariant<wref<CoverCommandParams>>(tmpVariant);
    };
    coverCommandParams = FromVariant<wref<CoverCommandParams>>(blackboard.GetVariant(GetAllBlackboardDefs().AICover.commandExposureMethods));
        ...
        if validExposureSpots[i].distanceToTarget <= lineOfSightTolerance && Equals(validExposureSpots[i].method, requestedExposureMethods[j]) {
          if validExposureSpots[i].distanceToTarget == 0.00 {
            ...
            if ArraySize(noCollisionExposureMethods) == 0 {
              ArrayPush(Deref(allAvailableExposureMethods), requestedExposureMethods[j]);
            };
          };
        };
        j += 1;
  ...
  public final static func ReturnHighestPriorityMethods(puppet: ref<ScriptedPuppet>, record: wref<AISubActionCover_Record>, const exposureMethods: script_ref<[AICoverExposureMethod]>) -> [AICoverExposureMethod] {
    ...
    while i < ArraySize(exposureMethodPriority) {
      ...
      j = 0;
      while j < ArraySize(Deref(exposureMethods)) {
        presence[EnumInt(Deref(exposureMethods)[j])] = 1;
        j += 1;
      };
      j = 0;
      while j < ArraySize(priority) {
        if presence[priority[j]] == 1 {
          ArrayPush(candidates, IntEnum<AICoverExposureMethod>(priority[j]));
        };
        j += 1;
      };
