...
public class AIInjectCombatThreatCommandParams extends ScriptedAICommandParams {
  ...
  @runtimeProperty("customEditor", "scnbPerformerPuppetRefSelector")
  public edit let targetPuppetRef: EntityReference;
...
public class AIRoadBlockadeMemberCommandParams extends ScriptedAICommandParams {
  ...
  public func CreateCommand() -> ref<AICommand> {
    let command: ref<AIRoadBlockadeMemberCommand> = new AIRoadBlockadeMemberCommand();
    command.duration = this.duration;
    return command;
  }
}
