...
public abstract class TweakAIActionRecord extends IScriptable {
  ...
  public final static func GetFriendlyName(record: TweakDBID, const nodeName: script_ref<String>) -> String {
  ...
  public final static func GetDebugActionNameFromRecord(record: TweakDBID, debugStringName: script_ref<String>) -> Bool {
  ...
  public final static func GetActionRecord(const context: ScriptExecutionContext, actionID: TweakDBID, actionDebugName: script_ref<String>, out actionRecord: wref<AIAction_Record>) -> Bool {
  ...
  public final static func GetSelectorRecord(const context: ScriptExecutionContext, selectorID: TweakDBID, selectorDebugName: script_ref<String>, out selectorRecord: wref<AIActionSelector_Record>) -> Bool {
    let record: ref<AIRecord_Record>;
  ...
  public final static func GetSequenceRecord(const context: ScriptExecutionContext, sequenceID: TweakDBID, sequenceDebugName: script_ref<String>, out sequenceRecord: wref<AIActionSequence_Record>) -> Bool {
    let record: ref<AIRecord_Record>;
  ...
  public final static func GetSmartCompositeRecord(const context: ScriptExecutionContext, smartCompositeID: TweakDBID, smartCompositeDebugName: script_ref<String>, out smartCompositeRecord: wref<AIActionSmartComposite_Record>) -> Bool {
    let record: ref<AIRecord_Record>;
  ...
  public final static func GetActionRecordFromSelector(const context: ScriptExecutionContext, selectorRecord: wref<AIActionSelector_Record>, actionDebugName: script_ref<String>, out actionRecord: wref<AIAction_Record>, out nodeIterator: Int32, out shouldCallAgain: Bool) -> Bool {
    ...
    while nodeIterator < count {
      ...
      if !IsDefined(actionRecord) {
        ...
        if IsDefined(actionRecord.AnimData().AnimVariationSubAction() as AISubActionRandomize_Record) {
          blackBoard = (ScriptExecutionContext.GetOwner(context) as ScriptedPuppet).GetAIControllerComponent().GetActionBlackboard();
          if FromVariant<TweakDBID>(blackBoard.GetVariant(GetAllBlackboardDefs().AIAction.ownerLastAnimVariationAction)) != actionRecord.GetID() {
          ...
          if AICondition.ActivationCheck(context, actionRecord) {
            blackBoard.SetVariant(GetAllBlackboardDefs().AIAction.ownerLastAnimVariationAction, ToVariant(actionRecord.GetID()));
            return true;
          };
        } else {
          if AICondition.ActivationCheck(context, actionRecord) {
  ...
  public final static func GetActionRecordFromSequence(const context: ScriptExecutionContext, sequenceRecord: wref<AIActionSequence_Record>, actionDebugName: script_ref<String>, out actionRecord: wref<AIAction_Record>, out sequenceIterator: Int32, out shouldCallAgain: Bool) -> Bool {
    let alternativesLimit: Uint32;
    let alternativesLimitEnabled: Bool;
    let blackBoard: ref<IBlackboard>;
    let count: Int32;
...
public class TweakAIAction extends TweakAIActionAbstract {
  ...
  @runtimeProperty("customEditor", "TweakDBGroupInheritance;AIAction")
  public edit let m_record: TweakDBID;

  public func GetDescription(context: ScriptExecutionContext) -> String {
    let result: String = super.GetDescription(context);
    if Equals(result, "") {
      return TDBID.ToStringDEBUG(this.m_record);
    };
    return result;
  }
...
public class TweakAIActionSelector extends TweakAIActionAbstract {
  ...
  @runtimeProperty("customEditor", "TweakDBGroupInheritance;AIActionSelector")
  ...
  private func Debug_GetBaseActionId() -> TweakDBID {
    let actionRecord: ref<AIAction_Record>;
    let selectorRecord: ref<AIActionSelector_Record> = this.m_selectorRecord;
    if !IsDefined(selectorRecord) {
      return t"NewPerks.Intelligence_Left_Milestone_2.preventInQueueAgain";
    };
    if this.m_nodeIterator < 0 {
      actionRecord = selectorRecord.DefaultAction();
    } else {
      if this.m_nodeIterator < selectorRecord.GetActionsCount() {
        actionRecord = selectorRecord.GetActionsItem(this.m_nodeIterator);
      } else {
        actionRecord = null;
      };
    };
...
public class TweakAIActionSequence extends TweakAIActionAbstract {
  ...
  @runtimeProperty("customEditor", "TweakDBGroupInheritance;AIActionSequence")
...
public class TweakAIActionSmartComposite extends TweakAIActionAbstract {
  ...
  @runtimeProperty("customEditor", "TweakDBGroupInheritance;AIActionSmartComposite")
  ...
  public func GetSmartCompositeRecord(const context: ScriptExecutionContext, smartCompositeID: TweakDBID, smartCompositeStringName: script_ref<String>, out smartCompositeRecord: wref<AIActionSmartComposite_Record>) -> Bool {
  ...
  private func GetActionRecord(const context: ScriptExecutionContext, actionDebugName: script_ref<String>, out actionRecord: wref<AIAction_Record>, out shouldCallAgain: Bool) -> Bool {
    ...
    this.RandomizeGracefulInterruptionConditionCheckInterval(smartCompositeRecord);
  ...
  private final func RandomizeGracefulInterruptionConditionCheckInterval(smartCompositeRecord: wref<AIActionSmartComposite_Record>) -> Void {
    let randomCheckIntervalMods: array<Float>;
    this.m_gracefulInterruptionCheckRandomizedInterval = 0.00;
    this.m_hasGracefulInterruptionConditions = false;
    if smartCompositeRecord.GetGracefulInterruptionConditionCount() > 0 {
      this.m_hasGracefulInterruptionConditions = true;
    };
    if this.m_hasGracefulInterruptionConditions && smartCompositeRecord.GracefulInterruptionConditionCheckInterval() > 0.00 {
      ...
      this.m_gracefulInterruptionCheckRandomizedInterval = smartCompositeRecord.GracefulInterruptionConditionCheckInterval();
      this.m_gracefulInterruptionCheckRandomizedInterval += randomCheckIntervalMods[RandRange(0, 3)];
    };
  }
  ...
  private func Update(context: ScriptExecutionContext) -> AIbehaviorUpdateOutcome {
    ...
    if !this.m_interruptionRequested {
      if this.m_hasGracefulInterruptionConditions && this.m_gracefulInterruptionCheckRandomizedInterval <= 0.00 || this.m_gracefulInterruptionCheckRandomizedInterval > 0.00 && EngineTime.ToFloat(ScriptExecutionContext.GetAITime(context)) >= this.m_conditionCheckTimeStamp + this.m_gracefulInterruptionCheckRandomizedInterval {
        if this.CheckGracefulInterruptionConditions(context) {
          if this.m_smartCompositeRecord.ConditionSuccessDuration() > 0.00 && this.m_conditionSuccessfulCheckTimeStamp < 0.00 {
            this.m_conditionSuccessfulCheckTimeStamp = EngineTime.ToFloat(ScriptExecutionContext.GetAITime(context));
          };
          if this.m_smartCompositeRecord.ConditionSuccessDuration() <= 0.00 || this.m_smartCompositeRecord.ConditionSuccessDuration() > 0.00 && EngineTime.ToFloat(ScriptExecutionContext.GetAITime(context)) >= this.m_conditionSuccessfulCheckTimeStamp + this.m_smartCompositeRecord.ConditionSuccessDuration() {
        ...
        this.m_conditionCheckTimeStamp = EngineTime.ToFloat(ScriptExecutionContext.GetAITime(context));
      };
    };
    switch super.Update(context) {
      case AIbehaviorUpdateOutcome.FAILURE:
  ...
  private final func RepeatComposite(context: ScriptExecutionContext) -> AIbehaviorUpdateOutcome {
    this.m_iteration += 1u;
    if this.m_smartCompositeRecord.Repeat() < 0 || this.m_iteration == Cast<Uint32>(this.m_smartCompositeRecord.Repeat()) {
      return AIbehaviorUpdateOutcome.SUCCESS;
    };
    this.Deactivate(context);
    this.ResetNodeIterator();
...
public class IdleActions extends TweakAIActionSmartComposite {
  ...
  public func GetSmartCompositeRecord(const context: ScriptExecutionContext, smartCompositeID: TweakDBID, smartCompositeDebugName: script_ref<String>, out smartCompositeRecord: wref<AIActionSmartComposite_Record>) -> Bool {
    let characterRecord: wref<Character_Record> = TweakDBInterface.GetCharacterRecord(ScriptExecutionContext.GetOwner(context).GetRecordID());
    if !IsDefined(characterRecord) {
      return false;
    };
...
public class PatrolAction extends TweakAIActionSmartComposite {
  ...
  public func GetSmartCompositeRecord(const context: ScriptExecutionContext, smartCompositeID: TweakDBID, smartCompositeDebugName: script_ref<String>, out smartCompositeRecord: wref<AIActionSmartComposite_Record>) -> Bool {
    let record: ref<AIRecord_Record>;
    let patrolActionID: TweakDBID = FromVariant<TweakDBID>(AIBehaviorScriptBase.GetPuppet(context).GetAIControllerComponent().GetAIPatrolBlackboard().GetVariant(GetAllBlackboardDefs().AIPatrol.patrolAction));
...
public class PatrolSpotAction extends TweakAIActionSmartComposite {
  ...
  public func GetSmartCompositeRecord(const context: ScriptExecutionContext, smartCompositeID: TweakDBID, smartCompositeDebugName: script_ref<String>, out smartCompositeRecord: wref<AIActionSmartComposite_Record>) -> Bool {
    ...
    let patrolActionName: CName = FromVariant<CName>(ScriptExecutionContext.GetMappingValue(context, this.m_patrolAction));
