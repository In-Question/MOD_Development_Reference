...
public class AISquadHelper extends IScriptable {
  ...
  public final static func GetSquadmates(obj: wref<GameObject>, membersList: script_ref<[wref<Entity>]>, opt dontRemoveSelf: Bool) -> Bool {
    let squadInterface: ref<SquadScriptInterface>;
    if AISquadHelper.GetSquadMemberInterface(obj, squadInterface) {
      membersList = squadInterface.ListMembersWeak();
      if !dontRemoveSelf {
        ArrayRemove(Deref(membersList), obj);
      };
    };
    return ArraySize(Deref(membersList)) > 0;
  }

  public final static func GetSquadmatesID(obj: wref<GameObject>, out membersListID: [EntityID], opt dontRemoveSelf: Bool) -> Bool {
    let i: Int32;
  ...
  public final static func HasSquadMemberComponent(obj: wref<GameObject>) -> Bool {
    if !IsDefined(obj) {
      return false;
    };
    return IsDefined(obj.GetSquadMemberComponent());
  }
  ...
  public final static func GetAllSquadMemberInterfaces(obj: wref<GameObject>) -> [ref<SquadScriptInterface>] {
  ...
  public final static func PlayerSquadOrderStringToEnum(const playerSquadOrderName: script_ref<String>) -> EAIPlayerSquadOrder {
    switch Deref(playerSquadOrderName) {
      case "OrderTakedown":
  ...
  public final static func GetCurrentSquadRing(puppet: wref<ScriptedPuppet>) -> gamedataAIRingType {
    ...
    ring = FromVariant<gamedataAIRingType>(blackboard.GetVariant(GetAllBlackboardDefs().AICover.currentRing));
    if NotEquals(ring, gamedataAIRingType.Invalid) {
      return ring;
    };
    ring = FromVariant<gamedataAIRingType>(blackboard.GetVariant(GetAllBlackboardDefs().AICover.lastCoverRing));
    return ring;
  }
  ...
  public final static func RemoveThreatFromSquad(puppet: wref<ScriptedPuppet>, const threat: script_ref<TrackedLocation>) -> Void {
    let i: Int32;
    let squadmate: wref<ScriptedPuppet>;
    let squadmates: array<wref<Entity>>;
    if !IsDefined(puppet) {
  ...
  public final static func RemoveThreatOnSquadmate(game: GameInstance, squadmate: wref<ScriptedPuppet>, const threat: script_ref<TrackedLocation>) -> Void {
    ...
    if IsDefined(tte) {
      tte.RemoveThreat(tte.MapThreat(Deref(threat).entity));
      tte.SetRecentlyDroppedThreat(Deref(threat).entity, Deref(threat).sharedLocation.position);
    };
  }

  public final static func GetThreatLocationFromSquad(puppet: wref<ScriptedPuppet>, threat: wref<Entity>, threatLocation: script_ref<TrackedLocation>) -> Bool {
    let i: Int32;
    let squadmate: wref<ScriptedPuppet>;
    let squadmates: array<wref<Entity>>;
  ...
  public final static func GeThreatLocationFromSquadmate(squadmate: wref<ScriptedPuppet>, threat: wref<Entity>, threatLocation: script_ref<TrackedLocation>) -> Bool {
  ...
  public final static func PullSquadSync(puppet: wref<ScriptedPuppet>, squadType: AISquadType) -> Void {
    ...
    let isPuppetPolice: Bool = NPCManager.HasTag(puppet.GetRecordID(), n"InActivePoliceChase");
    if !IsDefined(puppet) {
      return;
    };
    ...
    if AISquadHelper.GetSquadmates(puppet, squadmates, true) {
      ...
      while i < ArraySize(squadmates) {
        ...
        if IsDefined(squadmate) {
          if isPuppetPolice {
            if Vector4.Distance(puppet.GetWorldPosition(), squadmate.GetWorldPosition()) < 60.00 {
  ...
  public final static func PullSquadSyncOnSquadmate(game: GameInstance, squadmate: wref<ScriptedPuppet>, squadType: AISquadType, currentTopThreat: wref<Entity>) -> Void {
    ...
    if IsDefined(threatData.threat) && threatData.threat == currentTopThreat {
      return;
    };
...
public abstract class AIScriptSquad extends IScriptable {
  ...
  public final static func TicketDebugHelper(const ticketNameCheck: script_ref<String>, entity: wref<Entity>, ticketRecord: wref<AITicket_Record>) -> Bool {
