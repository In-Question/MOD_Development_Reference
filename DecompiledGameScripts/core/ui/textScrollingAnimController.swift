    ...
    if this.m_gapIndex != 0 && this.m_lineCount >= this.m_gapIndex {
      ...
      if this.m_binaryOnly {
        ...
        if ArraySize(this.m_scrollingText.textArray) == 0 {
          j = RoundF(RandRangeF(0.00, Cast<Float>(this.m_numOfLines)));
          if j == 0 {
          ...
          j = RoundF(RandRangeF(0.00, Cast<Float>(ArraySize(this.m_scrollingText.textArray))));
