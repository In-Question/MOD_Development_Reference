...
public native struct inkWidgetRef {
  ...
  public final static native func GetControllers(self: inkWidgetRef) -> [wref<inkLogicController>];

  public final static native func GetControllersByType(self: inkWidgetRef, controllerType: CName) -> [wref<inkLogicController>];
  ...
  public final static native func GetUserDataArray(self: inkWidgetRef, userDataTypeName: CName) -> [ref<inkUserData>];

  public final static native func GatherUserData(self: inkWidgetRef, userDataTypeName: CName, userDataCollection: [ref<inkUserData>]) -> Void;
...
public native struct inkTextRef extends inkLeafRef {
  ...
  public final static func SetLocalizedTextScript(self: inkTextRef, const locKey: script_ref<String>, opt textParams: ref<inkTextParams>) -> Void {
    if IsStringNumber(locKey) {
      inkTextRef.SetText(self, Deref(locKey), textParams);
    } else {
      if !IsStringValid(locKey) {
        inkTextRef.SetText(self, "", textParams);
      } else {
        inkTextRef.SetLocalizedTextString(self, Deref(locKey), textParams);
      };
    };
  }
  ...
  public final static native func SetWrappingAtPosition(self: inkTextRef, position: Float) -> Void;
}
