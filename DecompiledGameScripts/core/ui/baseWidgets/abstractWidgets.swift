...
public abstract native class inkWidget extends IScriptable {
  ...
  public final native func GetControllers() -> [wref<inkLogicController>];

  public final native func GetControllersByType(controllerType: CName) -> [wref<inkLogicController>];
  ...
  public final native func GetUserDataArray(userDataTypeName: CName) -> [ref<inkUserData>];

  public final native func GatherUserData(userDataTypeName: CName, userDataCollection: [ref<inkUserData>]) -> Void;
  ...
  public final native func FlagForVisualInvalidation() -> Void;
}
