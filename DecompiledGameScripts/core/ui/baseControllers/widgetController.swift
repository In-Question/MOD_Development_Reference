...
public abstract native class inkIGameController extends IScriptable {
  ...
  public final native func GetControllers(opt path: inkWidgetPath) -> [wref<inkLogicController>];

  public final native func GetControllersByType(controllerType: CName, opt path: inkWidgetPath) -> [wref<inkLogicController>];
  ...
  public final native func RequestProcessFitToViewport() -> Void;

  public final native func IsKeyboardConnected() -> Bool;
  ...
  public final func RequestWidgetFromLibrary(parentWidget: wref<inkWidget>, widgetRecord: ref<WidgetDefinition_Record>, opt screenTypeRecord: ref<DeviceScreenType_Record>, opt styleRecord: ref<WidgetStyle_Record>, opt id: CName, opt path: ResRef, spawnData: ref<AsyncSpawnData>) -> CName {
    ...
    if widgetRecord == null {
      ...
      while i < ArraySize(ids) {
        libraryID = StringToName(ids[i]);
        if IsDefined(this.CreateWidgetAsync(parentWidget, libraryID, libraryPath, spawnData)) {
          break;
        };
        i += 1;
      };
  ...
  public final func RequestWidgetFromLibraryById(parentWidget: wref<inkWidget>, id: CName, opt path: ResRef, spawnData: ref<AsyncSpawnData>, out asyncSpawnRequest: wref<inkAsyncSpawnRequest>) -> CName {
    let libraryID: CName;
    if IsNameValid(id) {
      libraryID = id;
      asyncSpawnRequest = this.CreateWidgetAsync(parentWidget, libraryID, path, spawnData);
    };
    return libraryID;
  }

  public final func RequestWidgetFromLibraryByRecord(parentWidget: wref<inkWidget>, widgetRecord: ref<WidgetDefinition_Record>, opt screenTypeRecord: ref<DeviceScreenType_Record>, opt styleRecord: ref<WidgetStyle_Record>, spawnData: ref<AsyncSpawnData>, out asyncSpawnRequest: wref<inkAsyncSpawnRequest>) -> CName {
    let i: Int32;
    let ids: array<String>;
    let libraryID: CName;
    let libraryPath: ResRef;
    ...
    while i < ArraySize(ids) {
      libraryID = StringToName(ids[i]);
      asyncSpawnRequest = this.CreateWidgetAsync(parentWidget, libraryID, libraryPath, spawnData);
      if IsDefined(asyncSpawnRequest) {
        break;
      };
      i += 1;
    };
  ...
  protected final func CreateWidgetAsync(parentWidget: wref<inkWidget>, id: CName, opt path: ResRef, spawnData: ref<AsyncSpawnData>) -> wref<inkAsyncSpawnRequest> {
    let returnValue: wref<inkAsyncSpawnRequest>;
    if parentWidget == null {
      return null;
    };
    if this.HasLocalLibrary(id) {
      spawnData.m_libraryID = id;
      returnValue = this.AsyncSpawnFromLocal(parentWidget, id, spawnData.m_callbackTarget, spawnData.m_functionName, spawnData);
    } else {
      if this.HasExternalLibrary(path, id) {
        spawnData.m_libraryID = id;
        returnValue = this.AsyncSpawnFromExternal(parentWidget, path, id, spawnData.m_callbackTarget, spawnData.m_functionName, spawnData);
      } else {
        returnValue = null;
      };
    };
...
public native class inkLogicController extends inkILogicController {
  ...
  public final native func SetCursorOverWidget(widget: wref<inkWidget>, opt time: Float) -> Void;
  ...
  public final native func PlayRumble(rStrength: RumbleStrength, rType: RumbleType, rPosition: RumblePosition) -> Void;

  public final native func PlayRumbleByName(eventName: CName) -> Void;

  public final native func PlayRumbleLoop(rStrength: RumbleStrength) -> Void;

  public final native func StopRumbleLoop(rStrength: RumbleStrength) -> Void;
