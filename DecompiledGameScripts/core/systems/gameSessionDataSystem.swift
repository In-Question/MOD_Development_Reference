...
public class GameSessionDataSystem extends ScriptableSystem {
  ...
  private let m_gameSessionDataModules: [ref<GameSessionDataModule>];
...
public class CameraDeadBodySessionDataModule extends GameSessionDataModule {
  ...
  public let m_cameraDeadBodyData: [ref<CameraDeadBodyInternalData>];
  ...
  public const func IsDataValid(data: Variant) -> Bool {
    let castedData: ref<CameraDeadBodyData> = FromVariant<ref<CameraDeadBodyData>>(data);
...
public class CameraTagEnemyLimitDataModule extends GameSessionDataModule {
  ...
  public let m_cameraList: [wref<SurveillanceCamera>];
  ...
  public const func IsDataValid(data: Variant) -> Bool {
    let castedData: ref<CameraTagLimitData> = FromVariant<ref<CameraTagLimitData>>(data);
    if !IsDefined(castedData) {
      return false;
    };
  ...
  public const func CheckData(data: Variant) -> Bool {
    if IsDefined(FromVariant<ref<SurveillanceCamera>>(data)) {
      return ArrayContains(this.m_cameraList, FromVariant<ref<SurveillanceCamera>>(data));
    };
    return false;
  }
