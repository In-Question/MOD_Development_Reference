...
public static func GetNotSavableClasses() -> [CName] {
...
public native class GamePuppetPS extends GameObjectPS {
  ...
  public final native const func HasQuickHackBegunUpload() -> Bool;

  public final native func SetHasQuickHackBegunUpload(newValue: Bool) -> Void;
  ...
  public final native func GetTpp() -> Bool;
