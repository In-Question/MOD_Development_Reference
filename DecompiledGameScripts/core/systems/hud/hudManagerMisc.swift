...
public class RefreshActorRequest extends HUDManagerRequest {
  ...
  private let requestedModules: [wref<HUDModule>];

  public final static func Construct(requesterID: EntityID, opt updateData: ref<HUDActorUpdateData>, opt suggestedModules: [wref<HUDModule>]) -> ref<RefreshActorRequest> {
    let i: Int32;
  ...
  public final const func GetRequestedModules() -> [wref<HUDModule>] {
...
public native class HUDActor extends IScriptable {
  ...
  private let activeModules: [wref<HUDModule>];
  ...
  public final const func GetActiveModules() -> [wref<HUDModule>] {
