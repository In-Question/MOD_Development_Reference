...
public native class NavigationSystem extends IScriptable {
  ...
  public final native const func FindPursuitPointsRange(playerPos: Vector4, pos: Vector4, dir: Vector4, radiusMin: Float, radiusMax: Float, count: Int32, navVisCheck: Bool, agentSize: NavGenAgentSize, out results: [Vector4], out fallbackResults: [Vector4]) -> Bool;
