...
public class GamplayQuestData extends IScriptable {
  ...
  public let m_objectives: [ref<GemplayObjectiveData>];
...
public class GameplayQuestSystem extends ScriptableSystem {
  ...
  private let m_quests: [ref<GamplayQuestData>];
  ...
  private final func HasQuest(const questUniqueId: script_ref<String>) -> Bool {
    let i: Int32 = 0;
