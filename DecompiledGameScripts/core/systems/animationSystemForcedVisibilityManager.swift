...
public class AnimationSystemForcedVisibilityEntityData extends IScriptable {
  ...
  private let m_forcedVisibilityInAnimSystemRequests: [ref<ForcedVisibilityInAnimSystemData>];

  private let m_delayedForcedVisibilityInAnimSystemRequests: [ref<ForcedVisibilityInAnimSystemData>];
...
public class AnimationSystemForcedVisibilityManager extends ScriptableSystem {
  ...
  private let m_entities: [ref<AnimationSystemForcedVisibilityEntityData>];
