...
public class SampleUITextSystemController extends inkGameController {
  ...
  private edit const let m_measurementWidgets: [inkWidgetRef];
  ...
  private final func UpdateStringParam(const value: script_ref<String>) -> Void {
    this.m_stringToInject = Deref(value);
    if IsDefined(this.m_textParams) {
